          ...
          <div class="card">
            ...
            <div class="card-body bg-light-gray">
              ...
              <div class="input-group">
                ...
                <form method="post" action="{{route('post_role_permissions')}}">
                  ...
                  <label class="cl-switch cl-switch-green">
                    ...
                    <input type="checkbox" name="create" id="create-{{$module}}" class="submit">
                ...
                <form method="post" action="{{route('post_role_permissions')}}">
                  ...
                  <input type="hidden" name="module_name" value="{{$module}}">
                  <input type="hidden" name="role_id" value="{{$selected_role_id}}">
                  <input type="checkbox" name="read" id="read-{{$module}}" class="submit">
                ...
                <form method="post" action="{{route('post_role_permissions')}}">
                  ...
                  <input type="hidden" name="module_name" value="{{$module}}">
                  <input type="hidden" name="role_id" value="{{$selected_role_id}}">
                  <input type="checkbox" name="update" id="update-{{$module}}" class="submit">
                ...
                <form method="post" action="{{route('post_role_permissions')}}">
                  ...
                  <input type="hidden" name="module_name" value="{{$module}}">
                  <input type="hidden" name="role_id" value="{{$selected_role_id}}">
                  <input type="checkbox" name="delete" id="delete-{{$module}}" class="submit">
              ...
              <div class="input-group">
                <span class="minWidth">{{underscoreToCamelCase($module)}}</span>
                <div class="mr-4">
                  <form action="{{url('user/role/permissions', $$module)}}" method="post">
                    @csrf
                    @if ($$module != NULL)
                    @method('PUT')
                    @endif
                ...
                <div class="mr-4">
                  <form action="{{url('user/role/permissions', $$module)}}" method="post">
                    ...
                    <label class="cl-switch cl-switch-green">
                      ...
                      <input type="checkbox" class="submit" name="read[]" id="read-{{$module}}" @if(@$$module->read ==
                      'on')
                      checked
                      @endif>
                      <span class="switcher"></span>
              ...
              <div class="input-group">
                ...
                <form method="post" action="{{route('post_role_permissions')}}">
                  ...
                  <label class="cl-switch cl-switch-green">
                    ...
                    <input type="checkbox" name="create" id="create-{{$module2}}" class="submit">
                    <span class="switcher"></span>
                  </label>
                ...
                <form method="post" action="{{route('post_role_permissions')}}">
                  ...
                  <input type="hidden" name="module_name" value="{{$module2}}">
                  <input type="hidden" name="role_id" value="{{$selected_role_id}}">
                  <input type="checkbox" name="read" id="read-{{$module2}}" class="submit">
                ...
                <form method="post" action="{{route('post_role_permissions')}}">
                  ...
                  <input type="hidden" name="module_name" value="{{$module2}}">
                  <input type="hidden" name="role_id" value="{{$selected_role_id}}">
                  <input type="checkbox" name="update" id="update-{{$module2}}" class="submit">
                ...
                <form method="post" action="{{route('post_role_permissions')}}">
                  ...
                  <input type="hidden" name="module_name" value="{{$module2}}">
                  <input type="hidden" name="role_id" value="{{$selected_role_id}}">
                  <input type="checkbox" name="delete" id="delete-{{$module2}}" class="submit">
              ...
              <div class="input-group">
                <span class="minWidth">{{underscoreToCamelCase($module2)}}</span>
                <div class="mr-4">
                  <form action="{{url('user/role/permissions', $$module2)}}" method="post">
                    @csrf
                    @if ($$module2 != NULL)
                    @method('PUT')
                    @endif
                ...
                <div class="mr-4">
                  <form action="{{url('user/role/permissions', $$module2)}}" method="post">
                    ...
                    <label class="cl-switch cl-switch-green">
                      ...
                      <input type="checkbox" class="submit" name="read[]" id="read-{{$module2}}" @if(@$$module2->read
                      == 'on')
                      checked
                      @endif>
                      <span class="switcher"></span>
              ...
              <hr>
              <h3> Claim Transaction Module </h3>
              <br>
              <br>

                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" id="sliptotalnilaiecendorsement" name="sliptotalnilaiec" placeholder="sum y &permil;" hidden="true" class="form-control form-control-sm floatTextBox2"/>
                                                                                </div>
                                                                            </td>
                                                                            <td>
                                                                                <div class="form-group">

...
<script type='text/javascript'>
    $('#addholedetail-btn').click(function(e){
        ...
        var golffieldhole = $('#hiogolffield').val();
        var event = $('#hioevent').val();
...
<script>
    ...
    { 
        ...
        $("#tabretro").attr('hidden','true');
            ...
            // $('#hioshareto2 .insertins').prop("disabled", false);
            // var tbl_long = document.getElementById("locRiskTable").rows.length;
            // console.log(tbl_long)
            // if(tbl_long < 2){
            //     var attr = $('#hioshareto2 .insertins').prop("disabled", true);
            //     if(typeof attr !== typeof undefined && attr !== false){
            //         $('#hioshareto2 .insertins').prop("disabled", false);
            //     }
            // }else if(tbl_long > 1){
            //     $('#hioshareto2 .insertins').prop("disabled", true);
            // }
            ...
            var currency_exc = $('#hiocurrency').val();
            if(currency_exc){
                $.ajax({
                    type:"GET",
...
<script type="text/javascript">
    ...
    $('#detailmodaldata').on('show.bs.modal', function(e) {
        ...
        $.ajax({
        url:'{{ url("/") }}/transaction-data/detailhioslip/'+codesl,
        type:"GET",
        beforeSend: function() { $("body").addClass("loading");  },
        complete: function() {  $("body").removeClass("loading"); },
        success:function(response)
        {
            ...
            if(response.deductible_panel && response.deductible_panel.length > 10)
            {
                ...
                if(response.status)
                {
                   ...
                   // $("#slipstatusdetail option[value=" + response.status + "]:first").hidden = false;
                   // $("#slipstatusdetail option[value=" + response.status + "]:first").selected = true;
                }

                if(response.source)
                {
                    $("#slipcedingbrokerdetail option").attr('hidden',true);
                    $("#slipcedingbrokerdetail option[value=" + response.source + "]:first").hidden = false;
                    $("#slipcedingbrokerdetail option[value=" + response.source + "]:first").selected = true;
                }

                if(response.source_2)
                {
                    $("#slipcedingdetail option").attr('hidden',true);
                    $("#slipcedingdetail option[value=" + response.source_2 + "]:first").hidden = false;
                    $("#slipcedingdetail option[value=" + response.source_2 + "]:first").selected = true;
                }

                if(response.currency)
                {
                    $("#slipcurrencydetail option[value=" + response.currency + "]:first").selected = true;
                }
                
                if(response.cob)
                {
                    $("#slipcobdetail option[value=" + response.cob + "]:first").selected = true;
                }

                if(response.koc)
                {
                    $("#slipkocdetail option[value=" + response.koc + "]:first").selected = true;
                }

                if(response.occupacy)
                {
                    $("#slipoccupacydetail option[value=" + response.occupacy + "]:first").selected = true;
                }

                if(response.build_const)
                {
                    $("#slipbld_constdetail option").attr('hidden',true);
                    $("#slipbld_constdetail option[value='" + response.build_const + "']:first").hidden = false;
                    $("#slipbld_constdetail option[value='" + response.build_const + "']:first").selected = true;
                }
                ...
                {
                    $("#sliptypedetail option[value=" + response.insured_type + "]:first").selected = true;
                }

                if(response.layer_non_proportional)
                {
                    $("#sliplayerproportionaldetail option[value=" + response.layer_non_proportional + "]:first").selected = true;
                }
                ...
                {
                    $("#sliprbdetail option[value=" + response.retro_backup + "]:first").selected = true;
                ...
                {
                    $("#sliptypetsidetail option[value=" + response.type_tsi + "]:first").selected = true;
                }

                if(response.type_share_tsi)
                {
                    $("#sharetypetsidetail option[value=" + response.type_share_tsi + "]:first").selected = true;
                }
        ...
        $.ajax({
            ...
            success:function(response)
            {
                ...
                if(response.status)
                {
                    ...
                    //$("#slipstatusupdate option[value=" + response.status + "]:first").selected = true;
                }

                if(response.source)
                {
                    $("#slipcedingbrokerupdate option[value=" + response.source + "]:first").selected = true;
                }

                if(response.source_2)
                {
                    $("#slipcedingupdate option[value=" + response.source_2 + "]:first").selected = true;
                }

                if(response.currency)
                {
                    $("#slipcurrencyupdate option[value=" + response.currency + "]:first").selected = true;
                }

                if(response.cob)
                {
                    $("#slipcobupdate option[value=" + response.cob + "]:first").selected = true;
                }

                if(response.koc)
                {
                    $("#slipkocupdate option[value=" + response.koc + "]:first").selected = true;
                }

                if(response.occupacy)
                {
                    $("#slipoccupacyupdate option[value=" + response.occupacy + "]:first").selected = true;
                }

                if(response.build_const)
                {
                    $("#slipbld_constupdate option[value='" + response.build_const + "']:first").selected = true;
                ...
                if(response.type_tsi)
                {
                    $("#sliptypetsiupdate option[value=" + response.type_tsi + "]:first").selected = true;
                }

                if(response.type_share_tsi)
                {
                    $("#sharetypetsiupdate option[value=" + response.type_share_tsi + "]:first").selected = true;
                }

                if(response.insured_type)
                {
                    $("#sliptypeupdate option[value=" + response.insured_type + "]:first").selected = true;
                }

                if(response.layer_non_proportional)
                {
                    //$("#sliplayerproportionalupdate option[value=" + response.layer_non_proportional + "]:first").selected = true;
                }

                if(response.retro_backup)
                {
                    $("#sliprbupdate option[value=" + response.retro_backup + "]:first").selected = true;
                    if(response.retro_backup == "NO")
                    {
                        $("#tabretroupdate").attr('hidden','true');
                    }
...
<script type="text/javascript">
    ...
    $('#endorsementmodaldata').on('show.bs.modal', function(e) {
        ...
        $.ajax({
            url:'{{ url("/") }}/transaction-data/detailendorsementhioslip/'+codesl,
            type:"GET",
            beforeSend: function() { $("body").addClass("loading");  },
            complete: function() {  $("body").removeClass("loading"); },
            success:function(response)
            {
                ...
                if(response.build_const)
                {
                 $("#slipbld_constendorsement option[value='" + response.build_const + "']:first").selected = true;
            ...
            if(response.type_share_tsi)
            {
                $("#sharetypetsiendorsement option[value=" + response.type_share_tsi + "]:first").selected = true;
            }
                ...
                if(sliprate != null){
                    ...
                    if(grossprm_to_nr != null){
                        ...
                        console.log('nre' + nasionalreinsurance)
                            ...
                            // $('#hioshare').val(sumourshare.replace(/,/g, "."));
                            $('#hiosharefrom').val(real_sumnre);
        ...
        if(choice == '1'){
            ...
            if(shareslipval != null){
                ...
                if(sliprate != null){
                    ...
                    if(grossprm_to_nr != null){
                        var nasionalreinsurance =  $('#hiosharefromendorsement').val();
                        var totalnre =  $('#hiosharetoendorsement').val();
                        var conv_totalnre =  parseInt(totalnre.replace(/,/g, ""));
                ...
                if(sliprate != null){
                    ...
                    if(grossprm_to_nr != null){
                        ...
                        console.log('nre' + nasionalreinsurance)
                            ...
                            $('#slipsumorupdate2').val(real_sumor);
                            // $('#hioshare').val(sumourshare.replace(/,/g, "."));
                            $('#hiosharefromupdate').val(real_sumnre);
        ...
        $.ajax({
            ...
            success:function(response){
                console.log(response)
                    ...
                    // var tsicheck = $('#hioshareto2').val();
                    // if(tsicheck != null){
                    //     $('#hioshareto2').prop("disabled", true);
                    // }
    ...
    $.ajax({
        ...
        success:function(response){
            ...
            $('#cid'+id).remove();
                ...
                //var real_sum = sum.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
                //$("#sliptotalsum").val(real_sum);
                //$("#hioshareto").val(real_sum);

                // var tbl_long = document.getElementById("locRiskTable").rows.length;

                // if(tbl_long < 2){
                //     var attr = $('#hioshareto2').prop("disabled", true);
                //     if(typeof attr !== typeof undefined && attr !== false){
                //         $('#hioshareto2').prop("disabled", false);
                //     }
                // }else if(tbl_long > 1){
                //     $('#hioshareto2').prop("disabled", true);
                // }
                ...
                success:function(response){
                    console.log(response)
                        ...
                        if(ceding_share == ''){
                            ...
                            $('#hioshare').val(conv_sum_ceding);
                            $('#hioshare2').val(conv_sum_ceding);
...
function deletelocationriskdetail(id){
    ...
    $.ajax({
        ...
        success:function(response){
            ...
            // $('#hioshareto').val(real_sumtotalnre);
        ...
        e.preventDefault();
         ...
         $.ajaxSetup({
               ...
               $.ajax({
                 ...
                 success:function(response)
                 {
                    swal("Success!", "Slip Fire & Engineering Slip Update Status Cancelled", "success")
                    console.log(response)
                    ...
                    error: function (request, status, error) {
                        //alert(request.responseText);
                        swal("Error!", "Slip Fire & Engineering Slip Update Error", "Update Error");
                    }
                });
...
<script type="text/javascript">
    $('#hioshareto2').keyup(function(){
        var tsislip = $('#sliptotalsum').val();
        var typetsi = $('#sliptypetsi').val();
        
        $('#hioshareto').val($(this).val());
        console.log($('#hioshareto').val())
   ...
   $('#slipshareendorsement').change(function (e) {
        if(e.keyCode != 9){
            if($(this).val() < -100 || $(this).val() > 100){
                ...
                $('#slipsumorendorsement2').val(real_sumor);
                // $('#hioshare').val(sumourshare.replace(/,/g, "."));
                $('#hiosharefromendorsement').val(real_sumnre);
...
<script type='text/javascript'>
    $('#addinsuredsave-btn').click(function(e){
       ...
       var fesinsured = $('#hioprefix').val();
       var fessuggestinsured = $('#autocomplete').val();
       var fessuffix = $('#autocomplete2').val();
       var fesshare = $('#hioshare').val();
       var fessharefrom  = $('#hiosharefrom').val();
       var fesshareto = $('#hioshareto').val();
       var fescoinsurance = $('#hiocoinsurance').val();
       var feuy = $('#hiouy').val();
       var fecurrency = $('#hiocurrency').val();
    ...
    if(fessuggestinsured == '' || fesshareto == ''){
        ...
        $.ajax({
         url:"{{ url('transaction-data/hio-insured/store') }}",
         type:"POST",
         data:{
             fesnumber:fesnumber,
         ...
         success:function(response)
         {
            swal("Success!", "Insured Hole In One Insert Success", "success")
            console.log(response)
            // $('#hiocountendorsement').val(response.count_endorsement);
            var real_ceding_share = response.ceding_share.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            $('#hioshare').val(real_ceding_share);
        ...
        error: function (request, status, error) {
                    //alert(request.responseText);
                    swal("Error!"+ request.responseText , "Insured Hole in One Insured Insert Error, please check input", "Insert Error");
                }
            });
    }
...
<script type='text/javascript'>
    $('#multi-file-upload-ajax').submit(function(e){
       ...
       var count_endorsement_ins = $('#hiocountendorsement').val();
                    ...
                    if(parseInt(jumlah_tgl) > 0){
                        ...
                        if(type_tsi == 1){
                            ...
                            if(tsislipval == new_instsi){
                                    ...
                                    $.ajax({
                                         url:"{{url('transaction-data/hio-slip/store')}}",
                                         type:"POST",
                                         data:{
                                           ...
                                           success:function(response)
                                           {
                                            swal("Success!", "Insured Hole in One Slip Insert Success", "success")
                                            console.log(response)
                                            ...
                                            // $('#hioshare').val(response.ourshare);
                                            // $('#hiosharefrom').val(response.sumshare);
                                        ...
                                        error: function (request, status, error) {
                                                //alert(request.responseText);
                                                swal("Error!", "Hole in One Slip Insert Error : " + request.responseText, "Insert Error");
                                            }
                                        });
    ...
    $('#multi-file-upload-ajax2').submit(function(e){
       ...
       $.ajax({
         ...
         data:{
           ...
           success:function(response)
           {
            swal("Success!", "Hole in One Slip Insert Success", "success")
            console.log(response)
    ...
    $('#multi-file-upload-ajaxupdate').submit(function(e){
       ...
       console.log('count endorsement ' + count_endorsement_ins)
         ...
         if(parseFloat(current_percent) == 100.00)
        {
                ...
                $.ajax({
                 url:"{{url('transaction-data/hio-slip/updateform')}}",
                 type:"POST",
                 data:{
                     code_ms:code_ms,
                     slipnumber:slipnumber,
                 ...
                 success:function(response)
                 {
                    swal("Success!", "Hole in One Slip Update Success", "success")
                    console.log(response)
                ...
                error: function (request, status, error) {
                    //alert(request.responseText);
                    swal("Error!", "Insured Hole in One Slip Update Error", "Update Error");
                }
                });
...
<script type='text/javascript'>
    $('#multi-file-upload-ajaxendorsement').submit(function(e){
       ...
       $.ajax({
         url:"{{url('transaction-data/hio-slip/endorsementstore')}}",
         type:"POST",
         data:{
             slipid:slipid,
             code_ms:code_ms,
         ...
         success:function(response)
         {
            swal("Success!", "Hole in One Slip Endorsement Success", "success")
            console.log(response)

            // var insured_data2=JSON.parse(response.insured_data);
            // $('#hiocountendorsement').val(insured_data2.count_endorsement);
        ...
        error: function (request, status, error) {
            //alert(request.responseText);
            swal("Error!", "Hole in One Slip Endorsement Error", "Insert Error");
        }
       ...
       if(response){
        ...
        if(response.insured_data){
            ...
            for(var i = 0; i < insured_list.length; i++) 
            {
                ...
                $('#hiosnumber').val(obj.number);
                $('#hiosinsured').val(obj.insured_prefix);
                $('#autocomplete').val(obj.insured_name);
                $('#autocomplete2').val(obj.insured_suffix);
                $('#hioshare').val(obj.share);
                $('#hiosharefrom').val(obj.share_from);
                $('#hiouy').val(obj.uy);
                $('#hioshareto').val(obj.share_to);

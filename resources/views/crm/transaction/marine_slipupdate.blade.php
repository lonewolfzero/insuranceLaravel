                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" value="{{ $insureddata->insured_name }}" id="autocomplete" name="msisuggestinsured" style="text-transform:uppercase;" class="form-control form-control-sm " data-validation="length" data-validation-length="0-350" placeholder="search for insured suggestion" required/>
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="" style="opacity: 0">{{__('insured 2')}}</label>
                                                    <input type="text" name="mcsuffix" id="autocomplete2" value="{{ $insureddata->insured_suffix }}" style="text-transform:uppercase;" class="form-control form-control-sm " data-validation="length" data-validation-length="0-350" placeholder="suffix: QQ or TBk" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="input-group">
                                                                <input type="text" id="mcsharefrom" value="{{ strval(number_format((float)$insureddata->share_from, 3, '.', ',')) }}" name="mcsharefrom" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-350" readonly="readonly" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="mcshare" name="mcshare" value="{{ strval(number_format($insureddata->share, 3, '.', ',')) }}" class="form-control form-control-sm money text-left"  data-validation="length" data-validation-length="0-350" readonly="readonly" />
                                                </div>
                                            </div>
                                    ...
                                    @endforeach
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="mcshareto" name="mcshareto" value="{{ strval(number_format($insureddata->share_to, 3, '.', ',')) }}" class="form-control form-control-sm money text-left"  data-validation="length" data-validation-length="0-350" />
                                                </div>
                                            </div>
                                        ...
                                        <div class="card card-primary">
                                            ...
                                            <div class="card-body">
                                                <div class="col-md-12 com-sm-12 mt-3">
                                                    <table id="shipdetailTable" id="tbodymain" class="table table-bordered table-striped">
                                                        <thead>
                                                            <tr>
                                                                <th>{{__('Ship Code')}}</th>
                                                                <th>{{__('Ship Name')}}</th>
                                                                    ...
                                                                    <table id="tiidid{{ $slt->id }}" width="600" class="table table-bordered table-striped">
                                                                        ...
                                                                        <tbody id="tbiidid{{ $slt->id }}">
                                                                            ...
                                                                            <tr id="intinsdetail{{ $detaillocrisk->id }}">
                                                                                ...
                                                                                <td>{{ number_format($detaillocrisk->percent,2,'.',',') }} %</td>
            ...
            <tbody>
               ...
               @foreach (@$slipdatadistict as $slipdatadistictdetail)
                 ...
                 <tr>
                      ...
                      <td>{{ @$slipdatadistictdetail->cedingbroker->name }} -
                        {{ @$slipdatadistictdetail->cedingbroker->company_name }}</td>
                      <td>{{ @$slipdatadistictdetail->ceding->name }} - {{ @$slipdatadistictdetail->ceding->company_name }}</td>
                      <td>{{ @$slipdatadistictdetail->status }}</td>
                      <td >{{ @$slipdatadistictdetail->endorsment }}</td>
                          @if($slipdatadistictdetail->endorsment == $maxdata->endorsment)
                       <td>
                        <div class="row">
                          @if ($slipdatadistictdetail->date_transfer == null)
                            <a class="text-primary mr-3 float-right " data-toggle="modal"
                              data-book-id="{{ @$slipdatadistictdetail->id }}" data-target="#detailmodaldata"
                            ...
                            <a class="text-primary mr-3 float-right " data-toggle="modal"
                              data-book-id="{{ @$slipdatadistictdetail->id }}" data-target="#updatemodaldata">
                              <button type="button" class="btn btn-sm btn-primary float-right" data-toggle="modal"
                                data-target="#updatemodaldata2">{{ __('Edit') }}</button>
                            </a>

                            @if($slipdatadistictdetail->status == 'cancel' || $slipdatadistictdetail->status == 'decline')
                                
                            @elseif($slipdatadistictdetail->status != 'endorsement')
                                <a class="text-primary mr-3 float-right " data-toggle="modal"
                                data-book-id="{{ @$slipdatadistictdetail->id }}" data-target="#cancelmodaldata">
                                <button type="button" class="btn btn-sm btn-primary float-right" data-toggle="modal"
                            ...
                            @if($slipdatadistictdetail->warning_flag == 1)
                              <button type="button" id="change-must" class="btn btn-sm btn-danger float-right">Must Change</button>
                            @endif

                            {{-- <a class="text-primary mr-3 float-right " data-toggle="modal" data-book-id="{{  @$slipdatadistictdetail->id }}" data-target="#endorsementmodaldata"> 
                                    <button type="button" id="btnendorsementslip" class="btn btn-sm btn-primary float-right" onclick="addendorsement({{  @$slipdatadistictdetail->id }})">{{__('Endorsement')}}</button>
                                </a> --}}
                          @elseif($slipdatadistictdetail->date_transfer != null || $slipdatadistictdetail->status == 'decline' ||
                            $slipdatadistictdetail->status == 'cancel')
                            ...
                            <a class="text-primary mr-3 float-right " data-toggle="modal"
                              data-book-id="{{ @$slipdatadistictdetail->id }}" data-target="#endorsementmodaldata">
                                ...
                                <div class="tab-content p-0 pt-1" id="custom-tabs-three-tabContent">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label for="">{{__('Number')}} </label>
                                                        <input type="text" id="slipnumber" name="slipnumber" class="form-control form-control-sm" data-validation="length" data-validation-length="0-25" value="{{ $slipnumform }}" readonly="readonly" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            <label>{{__('Prod Date')}}:</label>
                                                                <div class="input-group date" id="date" data-target-input="nearest">
                                                                        <input type="text" class="form-control form-control-sm" data-target="#date" id="slipprodyear" name="slipprodyear" value="{{ $currdate }}" readonly="readonly">
                                                                        <div class="input-group-append" >
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <form id="addconditionneeded">
                                                                                ...
                                                                                <td colspan="2">
                                                                                    <div class="form-group">
                                                                                        <select id="slipcncode" name="slipcncode" class="e1 form-control form-control-sm select2">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" id="sliptotalrate" value="" name="sliptotalrate" class="form-control form-control-sm floatTextBox" data-validation="length" data-validation-length="0-50"  placeholder="= a %; * sum y %; " />
                                                            <input type="text" id="sliptotalrate2" value="" name="sliptotalrate2" class="form-control form-control-sm floatTextBox" data-validation="length" data-validation-length="0-50" disabled placeholder="= a %;(rate)" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="input-group">
                                                                        <input type="text"  id="slipshare" name="slipshare" class="form-control form-control-sm floatTextBox" data-validation="length" data-validation-length="0-50"  />
                                                                        <div class="input-group-append">
                                                                            <div class="input-group-text"><i class="fa fa-percent" aria-hidden="true"></i></div> 
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="row d-flex flex-wrap">
                                                                <div class="col-md-12">
                                                                    <div class="input-group">
                                                                        <input type="text" id="slipcommission" name="slipcommission" class="form-control form-control-sm floatTextBox" data-validation="length" data-validation-length="0-50"  />
                                                                        <div class="input-group-append">
                                                                            <div class="input-group-text"><i class="fa fa-percent" aria-hidden="true"></i></div> 
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="input-group">
                                                                        <input type="text" id="slipvbroker" name="slipvbroker" value="0" class="form-control form-control-sm money text-left floatTextBox" data-validation="length" data-validation-length="0-50" placeholder="a" />
                                                                        <div class="input-group-append">
                                                                            <div class="input-group-text"><i class="fa fa-percent" aria-hidden="true"></i></div> 
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="input-group">
                                                                        <input type="hidden"  id="slipsumfee" name="slipsumfee"  class="form-control form-control-sm money text-left floatTextBox" data-validation="length" data-validation-length="0-50" placeholder="= a %; * b% * tsi * (100% - e%)" />
                                                                        <input type="text"  id="slipsumfee2" name="slipsumfee"  class="form-control form-control-sm money text-left floatTextBox" data-validation="length" data-validation-length="0-50" placeholder="= a %; * b% * tsi * (100% - e%)" />
                                    ...
                                    <div class="tab-pane fade" id="installment-details-id-tabpanel"  role="tabpanel" aria-labelledby="installment-details">
                                                                    ...
                                                                    <tfoot>
                                                                            <tr>
                                                                                <form id="addinstallmentinsured">
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="form-group">
                                                                                            <input type="text" id="sliptotalpercentinspan" class="floatTextBox" name="sliptotalpercentinspan" hidden="true" >
                                                                                            <input type="text" id="sliptotalamountinspan" class="floatTextBox" name="sliptotalamountinspan" hidden="true" >
                                        ...
                                        <input type="hidden" id="slipsumor"  name="slipsumor" class="form-control form-control-sm money text-left " />
                                         <input type="hidden" id="slipor" value="100" name="slipor" class="form-control form-control-sm floatTextBox2" data-validation="length" data-validation-length="0-50" />
                                                                        ...
                                                                        <td>
                                                                            <div class="form-group">
                                                                                <select id="sliprpcontract" name="sliprpcontract" class="form-control form-control-sm ">
                                                                                    ...
                                                                                    <option value="OWN RETENTION">OWN RETENTION</option>

...
<script type="text/javascript">
    ...
    $('input.amount').keyup(function(event) {
            ...
            // // reversed = $(this).val().split("").reverse().join("")
            // // while (result = reg.exec(reversed)) {
            // // str.push(result[2] ? result[2] : result[0])
            // // }
            // // console.log("hasil " + str.join(",").split("").reverse().join("").replace(",.","."))
                
            //     // format number
            //     $(this).val(function(index, value) {
            //         return value.replace(/\D/g, "").replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            //         // return value.replace(/^(?:\d{1,3}(?:,\d{3})*|\d+)(?:\.\d+)?$/);
            //     });
...
<script type="text/javascript">
    $('#slipcedingbroker').change(function(){
        ...
        if(cedbrok){
            $.ajax({
                type:"GET",
                url:"{{url('syariah/get-ceding-detail')}}?ceding_id="+cedbrok+"&insured_id="+insuredid+"&slip_type="+sliptype,
...
<script type="text/javascript">
    $('#slipcedingbrokerupdate').change(function(){
        ...
        if(cedbrok){
            $.ajax({
                type:"GET",
                url:"{{url('syariah/get-ceding-detail')}}?ceding_id="+cedbrok+"&insured_id="+insuredid,
                beforeSend: function() { $("body").addClass("loading");  },
                complete: function() {  $("body").removeClass("loading"); },
                success:function(res){  
                    console.log(res)      
    ...
    $('#slipcedingupdate').change(function(){
        ...
        if(ceding){
            $.ajax({
                type:"GET",
                url:"{{url('syariah/get-ceding-detail')}}?ceding_id="+ceding+"&insured_id="+insuredid,
                beforeSend: function() { $("body").addClass("loading");  },
                complete: function() {  $("body").removeClass("loading"); },
                success:function(res){  
                    console.log(res)      
    ...
    $('#slipoccupacy').change(function(){
        ...
        if(bld != ''){
            if(ocp_id){
                $.ajax({
                    type:"GET",
                    url:"{{url('syariah/get-building-rate')}}",
                    data: {
                        building: bld,
                        occupacy_id:ocp_id
                    },
    ...
    $('#sliptypetsi').change(function(){
        ...
        }else if(choice == '2')
        {
            if(cedbrok != null && ceding != null){
                ...
                $.ajax({
                    type:"GET",
                    url:"{{url('syariah/get-ceding-detail')}}?ceding_id="+ceding+"&insured_id="+insuredid+"&slip_type="+sliptype,
                    beforeSend: function() { $("body").addClass("loading");  },
                    complete: function() {  $("body").removeClass("loading"); },
                    success:function(res){  
                        console.log(res)      
...
<script  type='text/javascript'>
    ...
    $('#sliprate').keyup(function (e) {
         if(e.keyCode != 9){
             ...
             if(totalrateexc){
                     ...
                     var sum = isNaN(((conv_sumrate / 1000) * conv_tsi) * insurance) ? 0 :(((conv_sumrate / 1000) * conv_tsi) * insurance);
                     var real_sum = sum.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
             ...
             if(basic_premi){
                 ...
                 var bpsum = isNaN(((bpconv_sumrate / 1000) * bpconv_tsi) * bpinsurance) ? 0 :(((bpconv_sumrate / 1000) * bpconv_tsi) * bpinsurance);
                 ...
                 if(share){
                    ...
                    var conv_totalnre =  parseFloat(totalnre.replace(/,/g, ""));
                     ...
                     var sumgprmtonr = isNaN(conv_basre * shareslip ) ? 0 :(conv_basre * shareslip );
   ...
   { 
        ...
        { 
            ...
            var tsi = $("#sharetotalsum").val();
            var conv_tsi = parseFloat(tsi.replace(/,/g, ""));
            var sum = isNaN(((conv_sumrate / 100) * conv_tsi) * insurance) ? 0 :(((conv_sumrate / 100) * conv_tsi) * insurance);
            var real_sum = sum.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            ...
            if(basic_premi)
            {
                ...
                //var bpsum = isNaN(((bpconv_sumrate / 100) * bpconv_tsi) * bpinsurance) ? 0 :(((bpconv_sumrate / 100) * bpconv_tsi) * bpinsurance).toFixed(2) ;
                //var bpreal_sum = bpsum.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");

                var basic_premi2=parseFloat(basic_premi.replace(/,/g, ""));
                
                var sumsharetest=isNaN(basic_premi2*100) ? 0: (basic_premi2*100);
                console.log("sumsharetest "+sumsharetest)
                var sumsharetest2= isNaN(sumsharetest/bpconv_tsi) ? 0: (sumsharetest/bpconv_tsi);
                console.log("sumsharetest2 "+sumsharetest2)
                var sumsharetest3=isNaN(sumsharetest2/bpinsurance) ? 0: (sumsharetest2/bpinsurance);
                console.log("sumsharetest3 "+sumsharetest3)
                var sumsharetest4=isNaN(sumsharetest3-totalrateexc) ? 0: (sumsharetest3-totalrateexc);
                console.log("sumsharetest4 "+sumsharetest4)

                $('#sliprate').val(sumsharetest4);
                $('#sliptotalrate').val(sumsharetest3);
                $('#sliptotalrate2').val(sumsharetest3);
        ...
        else
        {
            ...
            if(basic_premi)
            {
                ...
                var sumsharetest=isNaN(basic_premi2/bpinsurance) ? 0: (basic_premi2/bpinsurance);
                console.log(sumsharetest)
                var sumsharetest2= isNaN(sumsharetest/bpconv_tsi) ? 0: (sumsharetest/bpconv_tsi);
                console.log(sumsharetest2)
                var sumsharetest3=isNaN(sumsharetest2*100) ? 0: (sumsharetest2*100);
                console.log(sumsharetest3)
            

                $('#sliprate').val(sumsharetest3);
                $('#sliptotalrate').val(sumsharetest3);
                $('#sliptotalrate2').val(sumsharetest3);
         ...
         if(e.keyCode != 9){
             if($(this).val() < -100 || $(this).val() > 100){
                ...
                // var totalnre =  $('#feshareto').val();
                 ...
                 var sum = isNaN(conv_basre * shareslip ) ? 0 :(conv_basre * shareslip );
                 var real_sum = sum.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
    ...
    $('#slipcommission').keyup(function (e) {
         ...
         if (keyCode != 9){
             ...
             var sum = isNaN(commision * conv_sumgrossprmtonr) ? 0 :(commision * conv_sumgrossprmtonr);
             var real_sum = sum.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
    ...
    $('#slipsumcommission2').keyup(function(e){
         ...
         if (keyCode != 9) {
             ...
             // if(commisionval != null){
                 var sum = isNaN((conv_sumcommision / conv_sumgrossprmtonr2)*100) ? 0 :((conv_sumcommision / conv_sumgrossprmtonr2)*100);
                 var real_sum = sum.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
                 ...
                 if(feebroker != null){
                     ...
                     var sumnetprmtonr = isNaN( conv_sumgrossprmtonr2 * ((100 - commision - feebroker)/100)) ? 0 :(conv_sumgrossprmtonr2 * ((100 - commision - feebroker)/100));
                     var real_sumnetprmtonr = sumnetprmtonr.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
    ...
    $('#slipsumfee2').keyup(function(e){
         ...
         if (keyCode != 9) {
             ...
             // if(feebrokerval != null){
                 var sumvbroker = isNaN((conv_sumfeebroker / conv_sumgrossprmtonr)*100) ? 0 :((conv_sumfeebroker / conv_sumgrossprmtonr)*100);
                 ...
                 var sumnetprmtonr = isNaN( conv_sumgrossprmtonr * ((100 - commision - feebroker)/100)) ? 0 :(conv_sumgrossprmtonr * ((100 - commision - feebroker)/100));
                 var real_sumnetprmtonr = sumnetprmtonr.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
    ...
    $('#slipippercentage').keyup(function (e) {
         ...
         if(keyCode != 9){
             ...
             var sum = isNaN(percent *  conv_sumnetprtonr) ? 0 :(percent *  conv_sumnetprtonr);
             var real_sum = sum.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
    ...
    $('#slipipamount').keyup(function(e){
         ...
         if(keyCode != 9){
            var amount =  $(this).val();
                 ...
                 var sum = isNaN((conv_amount /  conv_sumnetprtonr) * 100) ? 0 :((conv_amount /  conv_sumnetprtonr) * 100);
                 var real_sum = sum.toString();
                 console.log(sum)
                 console.log(real_sum)
                 $('#slipippercentage').val(real_sum);
 ...
 <script  type='text/javascript'>
   ...
   { 
        ...
        { 
            ...
            var tsi = $("#sharetotalsumupdate").val();
            var conv_tsi = parseFloat(tsi.replace(/,/g, ""));
            var sum = isNaN(((conv_sumrate / 100) * conv_tsi) * insurance) ? 0 :(((conv_sumrate / 100) * conv_tsi) * insurance).toFixed(2) ;
            var real_sum = sum.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            ...
            if(basic_premi)
            {
                ...
                $('#sliprateupdate').val(sumsharetest3);
                $('#sliptotalrateupdate').val(sumsharetest3);
                $('#sliptotalrateupdate2').val(sumsharetest3);
   ...
   { 
        ...
        { 
            ...
            if(basic_premi)
            {
                ...
                $('#sliprateendorsement').val(sumsharetest3);
                $('#sliptotalrateendorsement').val(sumsharetest3);
                $('#sliptotalrateendorsement2').val(sumsharetest3);
    ...
    $('#form-cancelstatus').submit(function(e){
        ...
        // alert('sukses');
         ...
         $.ajaxSetup({
               ...
               $.ajax({
                 url:"{{url('syariah/transaction-data/"+slip_type+"/cancelslip')}}",
                 type:"POST",
                 data:{
                     code_ms:code_ms,
...
<script type='text/javascript'>
    $('#adddeductibleinsured-btn').click(function(e){
       //alert('masuk');
        ...
        $.ajax({
         url:"{{ route('syariah.deductible.store') }}",
         type:"POST",
         data:{
...
<script type='text/javascript'>
    function deletedeductibledetail(id)
    {
        ...
        $.ajax({
            url:'{{ url("/") }}/syariah/delete-deductible-list/'+id,
            type:"DELETE",
            data:{
                _token:token2
            },
...
<script type='text/javascript'>
    $('#addextendcoverageinsured-btn').click(function(e){
       ...
       $.ajax({
             url:"{{ route('syariah.extendcoverage.store') }}",
             type:"POST",
             data:{
...
<script type='text/javascript'>
    function deleteextendcoveragedetail(id)
    {
        ...
        $.ajax({
            url:'{{ url("/") }}/syariah/delete-extendcoverage-list/'+id,
            type:"DELETE",
            data:{
                _token:token2
            },
    ...
    $('#addinstallmentinsured-btn').click(function(e){
       ...
       if(new Date(newinstallmentdate) >= new Date(newproddate)){
            if(real_count_percent <= 100){
               ...
               $.ajax({
                 url:"{{ route('syariah.installment.store') }}",
                 type:"POST",
                 data:{
...
<script type='text/javascript'>
    function deleteinstallmentdetail(id)
    {
        ...
        $.ajax({
            url:'{{ url("/") }}/syariah/delete-installment-list/'+id,
            type:"DELETE",
            data:{
                _token:token2
            },
...
<script type='text/javascript'>
    $('#addretrocessioninsured-btn').click(function(e){
       ...
       $.ajax({
         url:"{{ route('syariah.retrocession.store') }}",
         type:"POST",
         data:{
             type:type,
             contract:contract,
...
<script type='text/javascript'>
    function deleteretrocessiondetail(id)
    {
        ...
        $.ajax({
            url:'{{ url("/") }}/syariah/delete-retrocession-list/'+id,
            type:"DELETE",
            data:{
                _token:token2
            },
            ...
            if(btnins == "Save"){
                ...
                if(parseFloat(current_percent) == 100.00)
                {
                    ...
                    if(parseInt(jumlah_tgl) > 0){
                        ...
                        var int_tsislipval = parseFloat(conv_tsiinsval);
                        ...
                        if(type_tsi == 1){
                            ...
                            if(tsislipval == tsiinsval){
                                    ...
                                    $.ajax({
                                            url:"{{url('syariah/transaction-data/"+sliptypeform+"/storeslip')}}",
                                            type:"POST",
                                            data:{
                                        ...
                                        if(TotalFiles > 0){
                                            ...
                                            $.ajax({
                                                type:'POST',
                                                url: "{{ url('syariah/store-multi-file-ajax')}}",
                                                data: formData,
                                                cache:false,
                                                contentType: false,
                                                processData: false,
                            ...
                            if(int_tsislipval == int_cedshareins){
                                    $.ajaxSetup({
                                        headers: {
                                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                                        }
       ...
       console.log('count endorsement ' + count_endorsement_ins)
        ...
        if(parseFloat(current_percent) == 100.00)
        {
             $.ajaxSetup({
               ...
               $.ajax({
                 url:"{{url('syariah/transaction-data/"+sliptypeform+"/updateslip')}}",
                 type:"POST",
                 data:{
                     code_ms:code_ms,
                     slipnumber:slipnumber,
                 ...
                 success:function(response)
                 {
                    ...
                    if(response.new_share_nasre){
                        ...
                        if(sliptypeform == 'fe'){
                            ...
                            $('#flsharefrom').val(real_nasre);
                        }else if(sliptypeform == 'hem'){
                            $('#hemsharefrom').val(real_nasre);
                        }else if(sliptypeform == 'mp'){
                            $('#mpsharefrom').val(real_nasre);
                        }else if(sliptypeform == 'hio'){
                            $('#hiosharefrom').val(real_nasre);
                        }else if(sliptypeform == 'pa'){
                            $('#pasharefrom').val(real_nasre);
                        }
...
<script type='text/javascript'>
    $('#multi-file-upload-ajaxendorsement').submit(function(e){
       ...
       $.ajax({
         url:"{{url('syariah/transaction-data/"+sliptypeform+"/endorsementslip')}}",
         type:"POST",
         data:{
             slipid:slipid,
             code_ms:code_ms,
...
<script type="text/javascript">
    ...
    $('#detailmodaldata').on('show.bs.modal', function(e) {
        ...
        $.ajax({
        url:'{{ url("/") }}/syariah/transaction-data/'+sliptype+'/detail-slip/'+codesl,
        type:"GET",
        beforeSend: function() { $("body").addClass("loading");  },
        complete: function() {  $("body").removeClass("loading"); },
        success:function(response)
...
<script type="text/javascript">
    ...
    $('#endorsementmodaldata').on('show.bs.modal', function(e) {
        ...
        $.ajax({
            url:'{{ url("/") }}/syariah/transaction-data/'+sliptype+'/detail-endorsement/'+codesl,
            type:"GET",
            beforeSend: function() { $("body").addClass("loading");  },
            complete: function() {  $("body").removeClass("loading"); },
            success:function(response)
...
<script type="text/javascript">
    ...
    $('#cancelmodaldata').on('show.bs.modal', function(e) {
        ...
        $.ajax({
            url:'{{ url("/") }}/syariah/transaction-data/detailslip/'+codesl,
            type:"GET",
            beforeSend: function() { $("body").addClass("loading");  },
            complete: function() {  $("body").removeClass("loading"); },
            success:function(response)

                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" id="autocomplete2" name="pasuffix" value="{{ $insureddata->insured_suffix }}" style="text-transform:uppercase;" class="form-control form-control-sm " data-validation="length" data-validation-length="0-50" placeholder="suffix: QQ or TBk" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" id="pasharefrom" name="pasharefrom" value="{{ strval(number_format($insureddata->share_from, 2, '.', ',')) }}" class="form-control form-control-sm amount floatamount" data-validation="length" readonly="readonly" data-validation-length="0-50" required/>
                                                    <input type="text" id="pasharefrom2" name="pasharefrom" value="{{ strval(number_format($insureddata->share_from, 2, '.', ',')) }}" class="form-control form-control-sm amount floatamount" data-validation="length" readonly="readonly" data-validation-length="0-50" required/>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="input-group">
                                                                <input type="text" id="pashare" name="pashare" value="{{ strval(number_format($insureddata->share, 2, '.', ',')) }}" class="form-control form-control-sm amount floatamount" data-validation="length" readonly="readonly" data-validation-length="0-50" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="pashareto" name="pashareto" value="{{ strval(number_format($insureddata->share_to, 2, '.', ',')) }}" class="form-control form-control-sm amount floatamount" data-validation="length" data-validation-length="0-50" required/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="">{{__('NASIONAL RE Share')}}</label>
                                                    <input type="hidden" id="pasharefrom" name="pasharefrom" class="form-control form-control-sm amount floatamount" data-validation="length"  data-validation-length="0-50" />
                                                    <input type="text" id="pasharefrom2" name="pasharefrom2" class="form-control form-control-sm amount floatamount" data-validation="length" data-validation-length="0-50" disabled/>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="input-group">
                                                                <input type="hidden" id="pashare" name="pashare" class="form-control form-control-sm amount floatamount" data-validation="length" data-validation-length="0-50" />
                                                                <input type="text" id="pashare2" name="pashare2" class="form-control form-control-sm amount floatamount" data-validation="length" data-validation-length="0-50" disabled/>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="">{{__('Total Sum Insured')}}</label>
                                                    <input type="text" id="pashareto" name="pashareto" class="form-control form-control-sm amount floatamount" data-validation="length" data-validation-length="0-50" required/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@include('crm.transaction.facultative_syariah.js.header_pa_js')
@endsection
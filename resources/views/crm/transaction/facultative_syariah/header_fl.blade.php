    ...
    <div class="content-wrapper">
        <!-- Content Header (Page header) -->
            <div class="container-fluid">
                ...
                @if($route_active == 'Financial Line - Slip Update')
                    <form>
                        @csrf
                            <div class="card">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <input type="text" name="flsuffix" id='autocomplete2'  value="{{$insureddata->insured_suffix}}" style="text-transform:uppercase;" class="form-control form-control-sm " data-validation="length" data-validation-length="2-50" placeholder="suffix: QQ or TBk" required/>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input id="flsharefrom" type="text"  name="flsharefrom" value="{{$insureddata->share_from}}"  class="form-control form-control-sm amount floatamount" data-validation="length" data-validation-length="0-50" readonly="readonly" />
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-10">
                                                                        ...
                                                                        <input type="number" min="0"  value="{{$insureddata->share}}" step=".01" id="flshare" name="flshare" class="form-control form-control-sm amount floatamount" data-validation="length" data-validation-length="0-250" readonly/>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-2">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="flsharefrom" type="hidden" name="flsharefrom" value="0" class="form-control form-control-sm amount floatamount" data-validation="length" data-validation-length="0-50"   />
                                                            <input id="flsharefrom2" type="text" name="flsharefrom2" value="0" class="form-control form-control-sm amount floatamount" data-validation="length" data-validation-length="0-50" disabled/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="input-group">
                                                                        <input type="hidden" id="flshare"  name="flshare" class="form-control form-control-sm amount floatamount" data-validation="length" data-validation-length="0-250"  />
                                                                        <input type="text" id="flshare2"  name="flshare2" class="form-control form-control-sm amount floatamount" data-validation="length" data-validation-length="0-250" disabled />
                                                                        {{-- <div class="input-group-append">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="">{{__('Total Sum Insured')}}</label>
                                                            <input id="flshareto2" type="text"  name="flshareto" class="form-control form-control-sm amount floatamount" value="" data-validation="length" data-validation-length="1-50" />
                                                            <input id="flshareto"  type="hidden" name="flshareto" value="0" class="form-control form-control-sm amount floatamount" data-validation="length" data-validation-length="0-50" />
                                                        </div>
                                                    </div>
...
@include('crm.transaction.facultative_syariah.js.header_fl_js')
@endsection
...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            @if($route_active == 'Moveable Property - Slip Update')
                            ...
                            <div class="tab-content" id="custom-tabs-three-tabContent">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" name="mpsuggestinsured" id='autocomplete' value="{{$insureddata->insured_name}}" class="form-control form-control-sm " style="text-transform:uppercase;" data-validation="length" data-validation-length="2-50" placeholder="search for insured suggestion" required/>
        
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label for="" style="opacity: 0">{{__('insured 2')}}</label>
                                                            <input type="text" name="mpsuffix" id='autocomplete2'  value="{{$insureddata->insured_suffix}}" class="form-control form-control-sm " style="text-transform:uppercase;" data-validation="length" data-validation-length="2-50" placeholder="suffix: QQ or TBk" required/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="mpsharefrom" type="text"  name="mpsharefrom" value="{{$insureddata->share_from}}"  class="form-control form-control-sm amount floatamount" data-validation="length" data-validation-length="0-50" readonly="readonly" />
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-10">
                                                                    <div class="input-group">
                                                                        <input type="text" value="{{$insureddata->share}}" id="mpshare" name="mpshare" class="form-control form-control-sm amount floatamount" data-validation="length" data-validation-length="0-250" readonly/>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select id="mpcurrency" name="mpcurrency" class="e1 form-control form-control-sm ">
                                                            ...
                                                            <input type="hidden" name="mpkurs" id="mpkurs">
                                                    </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input id="mpshareto2" type="text" name="mpshareto"
                                                        ...
                                                        <input id="mpshareto" type="hidden" name="mpshareto"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="mpuy" name="mpuy" class="form-control form-control-sm ">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <label for="" style="opacity: 0">{{__('insured 1')}}</label>
                                                            <input type="text" name="mpsuggestinsured" id='autocomplete' class="form-control form-control-sm " style="text-transform:uppercase;" data-validation="length" data-validation-length="0-50" placeholder="search for insured suggestion" required/>
        
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label for="" style="opacity: 0">{{__('insured 2')}}</label>
                                                            <input type="text" name="mpsuffix" id='autocomplete2' class="form-control form-control-sm " style="text-transform:uppercase;" data-validation="length" data-validation-length="0-50" placeholder="suffix: QQ or TBk" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="mpsharefrom" type="hidden" name="mpsharefrom" value="0" class="form-control form-control-sm amount floatamount" data-validation="length" data-validation-length="0-50"   />
                                                            <input id="mpsharefrom2" type="text" name="mpsharefrom2" value="0" class="form-control form-control-sm amount floatamount" data-validation="length" data-validation-length="0-50"  disabled />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-10">
                                                                    <div class="input-group">
                                                                        <input type="hidden"  id="mpshare" name="mpshare" class="form-control form-control-sm amount floatamount" data-validation="length" data-validation-length="0-250" />
                                                                        <input type="text"  id="mpshare2" name="mpshare2" class="form-control form-control-sm amount floatamount" data-validation="length" data-validation-length="0-250" disabled/>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="">{{__('Total Sum Insured')}}</label>
                                                            <input id="mpshareto2" type="text"  name="mpshareto" class="form-control form-control-sm amount floatamount" value="" data-validation="length" data-validation-length="1-50" />
                                                            <input id="mpshareto"  type="hidden" name="mpshareto" value="0" class="form-control form-control-sm amount floatamount" data-validation="length" data-validation-length="0-50" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" id="mpcountendorsement" name="mpcountendorsement" class="form-control form-control-sm " data-validation="length"  data-validation-length="0-12" readonly="readonly"/>
                                                </div>
                                            </div>
                                        </div>
...
@include('crm.transaction.facultative_syariah.js.header_mp_js')
@endsection
                ...
                <div class="modal-content bg-light-gray">
                    ...
                    @csrf
                            <div class="card card-tabs">
                                ...
                                <div class="card-body bg-light-gray">
                                    <div class="tab-content p-0 pt-1" id="custom-tabs-three-tabContent">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" min="0" value="" step=".0001" id="countendorsementupdate" name="countendorsementupdate" class="form-control form-control-sm " data-validation="length" data-validation-length="0-50" placeholder="" />
                                                        <input type="text" min="0" value="" step=".0001" id="countendorsementupdate2" name="countendorsementupdate" class="form-control form-control-sm " data-validation="length" data-validation-length="0-50" placeholder="" disabled="" />
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="input-group">
                                                                            <input type="text" id="slippctupdate" name="slippctupdate" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50" placeholder="pct" />
                                                                            <div class="input-group-append">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="col-md-12 com-sm-12 mt-3">
                                                                        ...
                                                                        <table class="table table-bordered table-striped">
                                                                            <tbody>
                                                                                 <tr>
                                                                                    <form id="addconditionneededupdate">
                                                                                        @csrf
                                                                                        <td colspan="2">
                                                                                            <div class="form-group">
                                                                                        ...
                                                                                        <td>
                                                                                            <div class="form-group">
                                                                                                <button type="button" class="btn btn-md btn-primary" id="addconditionneededupdate-btn">{{__('Add')}}</button>
                                                                                            </div>
                                                                                        </td>
                                                                                    </form>
                                                                                </tr>
                                                        ...
                                                        <div class="card-header bg-gray">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <button id="addhullcountupdate-btn" type="button" class="btn btn-sm btn-primary float-right" data-toggle="modal" data-target="#ModalCountHullUpdate">{{__('Add')}}</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12 com-sm-12">
                                                                    <table id="marineHullCountTableUpdate" class="table table-bordered table-striped">
                                                                        <thead>
                                                                            <tr>
                                                                                <th>{{__('Type')}}</th>
                                                                                <th>{{__('Share %')}}</th>
                                                                    ...
                                                                    <table id="marineHullCountTableUpdate2" class="table table-bordered table-striped">
                                                                         <tbody>
                                                                            <tr id="totalhullupdate">
                                                                                <th>Total</th>
                                                                                ...
                                                                                <th>
                                                                                    <input type="text" id="totalhullpremiupdate" class="form-control form-control-sm money text-left" name="" readonly="true">
                                                                                </th>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="input-group">
                                                                            <input type="text"  id="slipshareupdate" name="slipshareupdate" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50"  />
                                                                            <div class="input-group-append">
                                                                                <div class="input-group-text"><i class="fa fa-percent" aria-hidden="true"></i></div> 
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="hidden" id="slipgrossprmtonrupdate" name="slipgrossprmtonrupdate" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50" placeholder="a %  * tsi * b%"  />
                                                                <input type="text" id="slipgrossprmtonrupdate2" name="slipgrossprmtonrupdate2" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50" placeholder="a % * tsi * b% " disabled />
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="row d-flex flex-wrap">
                                                                    <div class="col-md-12">
                                                                        <div class="input-group">
                                                                            <input type="text" id="slipcommissionupdate" name="slipcommissionupdate" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50"  />
                                                                            <div class="input-group-append">
                                                                                <div class="input-group-text"><i class="fa fa-percent" aria-hidden="true"></i></div> 
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="hidden" id="slipsumcommissionupdate" name="slipsumcommissionupdate" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50" placeholder="= a % * b% * tsi * (100% - d%)"  />
                                                                <input type="text" id="slipsumcommissionupdate2" name="slipsumcommissionupdate2" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50" placeholder="= a % * b% * tsi * (100% - d%)" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="input-group">
                                                                            <input type="text" id="slipvbrokerupdate" name="slipvbrokerupdate" value="0" class="form-control form-control-sm money text-left money text-left" data-validation="length" data-validation-length="0-50" placeholder="a" />
                                                                            <div class="input-group-append">
                                                                                <div class="input-group-text"><i class="fa fa-percent" aria-hidden="true"></i></div> 
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="input-group">
                                                                            <input type="hidden"  id="slipsumfeeupdate" name="slipsumfeeupdate"  class="form-control form-control-sm money text-left money text-left" data-validation="length" data-validation-length="0-50" placeholder="= a % * b% * tsi * (100% - e%)" />
                                                                            <input type="text"  id="slipsumfeeupdate2" name="slipsumfeeupdate"  class="form-control form-control-sm money text-left money text-left" data-validation="length" data-validation-length="0-50"  placeholder="= a % * b% * tsi * (100% - e%)" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" id="slipnetprmtonrupdate" name="slipnetprmtonrupdate" class="form-control form-control-sm money text-left" data-validation="length" placeholder="=a % * b% * tsi * (100% - d%)" data-validation-length="0-50" />
                                                        <input type="text" id="slipnetprmtonrupdate2" name="slipnetprmtonrupdate2" class="form-control form-control-sm money text-left" data-validation="length" placeholder="= a % * b% * tsi * (100% - d% - e%)" data-validation-length="0-50" disabled/>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="installment-details-id4" role="tabpanel" aria-labelledby="installment-details">
                                                                    ...
                                                                    <div class="col-md-12 com-sm-12 mt-3">
                                                                        ...
                                                                        <tr>
                                                                           <td>
                                                                            ...
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="text"  id="slipippercentageupdate" name="slipippercentageupdate" placeholder="w" class="form-control form-control-sm money text-left" />
                                                                                    <div class="input-group-append">
                                                                                        <div class="input-group-text"><i class="fa fa-percent" aria-hidden="true"></i>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            <td>
                                                                                <div class="form-group">
                                                                                    <input type="text"  id="sliptotalpercentinspanupdate" class="money text-left"  hidden="true" name="sliptotalpercentinspanupdate">
                                                                                    <input type="text"  id="sliptotalamountinspanupdate" class="money text-left"  hidden="true" name="sliptotalamountinspanupdate">
                                            ...
                                            <input type="hidden" id="sliptotalpercentretroupdate" name="sliptotalpercentretroupdate" value="0">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="input-group">
                                                                        <input type="text" id="sliporupdate" value="" name="sliporupdate" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50" />
                                                                        <div class="input-group-append">
                                                                            <div class="input-group-text"><i class="fa fa-percent" aria-hidden="true"></i></div> 
                                                                        </div>
                                                                    </div>
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="form-group">
                                                                                            <div class="row">
                                                                                                <div class="col-md-10">
                                                                                                    <div class="input-group">
                                                                                                        <input type="text" id="sliprppercentageupdate" name="sliprppercentageupdate" class="form-control form-control-sm money text-left" />
                                                                                                        <div class="input-group-append">
                                                                                                            <div class="input-group-text"><i class="fa fa-percent" aria-hidden="true"></i></div> 
                                                                                                        </div>
                                                                                                    </div>
                             ...
                             <div class="modal fade" id="ModalCountHullUpdate" tabindex="-1" user="dialog" aria-hidden="true">
                                <div class="modal-dialog" user="document">
                                    <div class="modal-content bg-light-gray">
                                    <div class="modal-header bg-gray">
                                        <h5 class="modal-title">{{__('Marine Hull Premium Detail')}}</h5>
                                        <button type="button" class="close" data-dismiss="modal2" id="modalcountupdatebuttonclose" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <form id="form-hulltypecountupdate" >
                                        @csrf
                                        <div class="modal-body">
                                            <div class="col-md-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="mhtypeupdate" id="mhtypeupdate" class="form-control form-control-sm e1">
                                                    ...
                                                    <input type="hidden" id="hulltypehiddenupdate" class="form-control form-control-sm " >
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="input-group" lang="en-US">
                                                                    <input type="text" id="mhtypeshareupdate" name="mhtypeshareupdate"  class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50"  />
                                                                    <div class="input-group-append">
                                                                        <div class="input-group-text"><i class="fa fa-percent" aria-hidden="true"></i></div> 
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="mhtypeamountupdate" name="mhtypeamountupdate" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50"  />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 col-md-12">
                                                    ...
                                                    <input type="text" name="mhtyperateupdate" id="mhtyperateupdate" class="form-control form-control-sm money text-left" value="" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="mhtypepremiupdate" name="mhtypepremiupdate" class="form-control form-control-sm money text-left" value="" />
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" id="modalcountupdatebuttonclose2" data-dismiss="modal2">{{__('Close')}}</button>
                                            <button type="button" class="btn btn-info" id="addhulltypeupdate-btn">Add Count</button>
                                        </div>
                                    </form>
                                    </div>
                                </div>

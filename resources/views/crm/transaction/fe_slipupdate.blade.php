...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <div class="container-fluid">
      ...
      <div class="modal fade" id="addlocation" tabindex="-1" user="dialog" aria-labelledby="addlocationLabel"
        aria-hidden="true">
                      ...
                      <select name="country_location_id" id="country_location" class="e1 form-control form-control-sm "
                        ...
                        @foreach ($felookup as $felookuplocationdata)
                          @if ($felookuplocationdata->country_id == 102 || $felookuplocationdata->country_id == '102')
                            <option value="{{ $felookuplocationdata->country_id }}" selected>
                              {{ $felookuplocationdata->country->code }} -
                              {{ $felookuplocationdata->country->name }}</option>
                          @else
                            <option value="{{ $felookuplocationdata->country_id }}">
                              {{ $felookuplocationdata->country->code }} -
                              {{ $felookuplocationdata->country->name }}</option>
                          @endif
                        @endforeach
      ...
      <div class="modal fade" id="addlocdetailmodaldata" tabindex="-1" user="dialog" aria-labelledby="addLocationLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl" user="document">
          <div class="modal-content bg-light-gray">
            <div class="modal-header bg-gray">
                ...
                <div class="row">
                  <div class="col-md-6 col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" id="insurednoloc" name="insurednoloc" class="form-control form-control-sm"
                        value="" readonly />
                    </div>
                  </div>
                </div>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="input-group">
                            <input type="text" id="percentceding" name="percentceding"
                ...
                <div class="row">
                  <div class="col-md-6 col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" id="amountlocation" name="amountlocation"
                        class="form-control form-control-sm amount" data-validation="length"
                        data-validation-length="0-20" />
                    </div>
                  </div>
                </div>
                       ...
                       <td>
                        <div class="row">
                          @if ($slipdatatadetail->date_transfer == null)
                            ...
                            @if(strcmp($slipdatatadetail->status, 'cancel') != 0) {
                              <a class="text-primary mr-3 float-right " data-toggle="modal"

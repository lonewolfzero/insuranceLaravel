                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" name="hiosuffix" id="autocomplete2" value="{{ $insureddata->insured_suffix }}" maxlength="300" style="text-transform:uppercase;" class="form-control form-control-sm " data-validation="length" data-validation-length="0-300" placeholder="suffix: QQ or TBk" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="hiosharefrom" name="hiosharefrom" value="{{ strval(number_format($insureddata->share_from, 2, '.', ',')) }}" class="form-control form-control-sm money text-left" placeholder="total nasre share" data-validation="length" data-validation-length="0-50" readonly="readonly" />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="input-group">
                                                                <input type="text" id="hioshare" name="hioshare" value="{{ strval(number_format($insureddata->share, 2, '.', ',')) }}" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50" readonly="readonly" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="hioshareto" name="hioshareto" value="{{ strval(number_format($insureddata->share_to, 2, '.', ',')) }}" class="form-control form-control-sm money text-left" placeholder="total sum insured" data-validation="length" data-validation-length="0-50" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="">{{__('NASIONAL RE Share')}}</label>
                                                    <input type="hidden" id="hiosharefrom" name="hiosharefrom" class="form-control form-control-sm money text-left" placeholder="total nasre share" data-validation="length" data-validation-length="0-50"  />
                                                    <input type="text" id="hiosharefrom2" name="hiosharefrom" class="form-control form-control-sm money text-left" placeholder="total nasre share" data-validation="length" data-validation-length="0-50" disabled />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="input-group">
                                                                <input type="hidden" id="hioshare" name="hioshare" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50" />
                                                                <input type="text" id="hioshare2" name="hioshare2" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50" disabled />
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="">{{__('Total Sum Insured')}}</label>
                                                    <input type="text" id="hioshareto" name="hioshareto" class="form-control form-control-sm money text-left" placeholder="total sum insured" data-validation="length" data-validation-length="0-50" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@include('crm.transaction.facultative.js.header_hio_js')
@endsection
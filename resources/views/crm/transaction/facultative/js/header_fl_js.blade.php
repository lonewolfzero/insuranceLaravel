...
<script type='text/javascript'>
    $('#addinsuredsave-btn').click(function(e){
       //alert('masuk');
        ...
        console.log("fesnumber " + fesnumber)
        console.log("fesinsured " + fesinsured)
        console.log("fessuggestinsured " + fessuggestinsured)
        console.log("fessuffix " + fessuffix)
        console.log("fesshare " + fesshare)
        console.log("fessharefrom " + fessharefrom)
        console.log("fesshareto " + fesshareto)
        console.log("fecurrency " + fecurrency)
        console.log("fescoinsurance " + fescoinsurance)
        console.log("feflag_overseas " + feflag_overseas)
        console.log("febusiness_id " + febusiness_id)
        console.log("feuy " + feuy)
        console.log("flprincipal " + flprincipal)
        console.log("flobligee " + flobligee)
        if(fessuggestinsured == '' || fesshareto == ''){
            ...
            $.ajax({
            url:"{{ url('transaction-data/fl/storeheader') }}",
            type:"POST",
            data:{
                fesnumber:fesnumber,
            ...
            success:function(response)
            {
                ...
                window.location.href = "{{ url('transaction-data/fl/detailform/')}}/"+btoa(response.id);    
                // if(response.done == 1){

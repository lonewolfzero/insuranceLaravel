            ...
            $.ajax({
                ...
                success:function(response){
                    console.log(response)
                        ...
                        // var tsicheck = $('#hemshareto2').val();
                        // if(tsicheck != null){
                        //     $('#hemshareto2').prop("disabled", true);
                        // }
        ...
        $.ajax({
            ...
            success:function(response){
                ...
                $('#cid'+id).remove();
                    ...
                    // if(tbl_long < 2){
                    //     var attr = $('#hemshareto2').prop("disabled", true);
                    //     if(typeof attr !== typeof undefined && attr !== false){
                    //         $('#hemshareto2').prop("disabled", false);
                    //     }
                    // }else if(tbl_long > 1){
                    //     $('#hemshareto2').prop("disabled", true);
                    // }
...
<script type='text/javascript'>
    $('#addinsuredsave-btn').click(function(e){
       //alert('masuk');
        ...
        var fecurrency = $('#hemcurrency').val();
        var sliptype = 'hem';
        ...
        if(fessuggestinsured == '' || fesshareto == ''){
            ...
            $.ajax({
            url:"{{ url('transaction-data/hem/storeheader') }}",
            type:"POST",
            data:{
                fesnumber:fesnumber,
            ...
            success:function(response)
            {
                ...
                window.location.href = "{{ url('transaction-data/hem/detailform/')}}/"+btoa(response.id);    
                // if(response.done == 1){

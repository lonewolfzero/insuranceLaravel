    ...
    $('#addinsuredsave-btn').click(function(e){
       //alert('masuk');
        ...
        if(fessuggestinsured == '' || fesshareto == ''){
            ...
            $.ajax({
            url:"{{ url('transaction-data/pa/storeheader') }}",
            type:"POST",
            data:{
                fesnumber:fesnumber,
            ...
            error: function (request, status, error) {
                        ...
                        swal("Error!"+ request.responseText , "Insured Personal Accident Insured Insert Error, please check input", "Insert Error");
                    }
                });
        }
...
<script type="text/javascript">
    function getTsi(){
        ...
        if(valtsi != null){
            ...
            console.log('amountlocation ' + floatToString(parseFloat(sum_amount).toFixed(4)));

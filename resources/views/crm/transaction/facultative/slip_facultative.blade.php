                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select name="country_location_id" id="country_location" class="e1 form-control form-control-sm " required style="width: 100%;">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-12">
                            <div class="input-group mb-3">
                              ...
                              <select name="state_location_id" id="state_location" class="e1 form-control form-control-sm " required style="width: 96%;">
                              ...
                              <div class="input-group-append">
                                ...
                                <i class="fa fa-history" aria-hidden="true" id="btnRefreshState"></i></button>
                              </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-md-12">
                            <div class="form-group">
                                ...
                                <select name="city_location_id" id="city_location" class="e1 form-control form-control-sm " required style="width: 100%;">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-12">
                            <div class="form-group">
                                ...
                                <select name="address_location_id" id="address_location" class="e1 form-control form-control-sm " required style="width: 100%;">
                        ...
                        <div class="col-md-6 col-md-12">
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    ...
                                    <select id="ceding_id" name="ceding_id" class="e1 form-control form-control-sm " aria-required="true" style="width: 96%;">
                        ...
                        <div class="col-md-6 col-md-12">
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    ...
                                    <select id="slipinterestlistlocation" name="slipinterestlistlocation" class="e1 form-control form-control-sm " aria-required="true" style="width: 96%;">
                                        <option selected disabled>{{__('Insurable Interest')}}</option>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="input-group" lang="en-US">
                                            <input type="text" id="percentceding" name="percentceding"  class="form-control form-control-sm money text-left"   />
                                            <div class="input-group-append">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="amountlocation" name="amountlocation" class="form-control form-control-sm money text-left"  />
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <select id="slipcedingbroker" name="slipcedingbroker" class="e1 form-control form-control-sm " style="width:96%">
                                                    ...
                                                    <div class="input-group-append">
                                                        <button class="btn btn-outline-secondary" type="button" id="btnRefreshCedingSlip"><i class="fa fa-history" aria-hidden="true" ></i></button>
                                                </div>    
                                                </div>
                                                                ...
                                                                <table id="ExtendCoveragePanel" class="table table-bordered table-striped">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr id="iidextendcoverage{{ $isl->id }}">
                                                                            ...
                                                                            <td>{{ $isl->percentage }}</td>
                                                                            <td class="uangdata">@currency($isl->amount)</td>
                                                                    ...
                                                                    <tfoot>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="form-group">
                                                                                    <input type="text" id="slipnilaiec" name="slipnilaiec" placeholder="y &permil;" class="form-control form-control-sm money text-left"/>
                                                                                    <input type="text" id="sliptotalnilaiec" name="sliptotalnilaiec" placeholder="sum y &permil;" hidden="true" class="form-control form-control-sm money text-left"/>
                                                                                </div>
                                                                            </td>
                                                                            <td>
                                                                                <div class="form-group">
                                                                                    <input type="hidden" id="slipamountec" name="slipamountec" placeholder="=y*tsi" class="form-control form-control-sm money text-left " />
                                                                                    <input type="text" id="slipamountec2" name="slipamountec2" placeholder="=y*tsi" class="form-control form-control-sm money text-left " disabled/>
                                                                                </div>
                                                                            </td>
                                                                            <td>
                                                                                <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" id="sliptotalrate" value="" name="sliptotalrate" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50"   />
                                                        <input type="text" id="sliptotalrate2" value="" name="sliptotalrate2" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50" disabled w />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="slipbasicpremium" name="slipbasicpremium" class="form-control form-control-sm money text-left " data-validation="length" data-validation-length="0-50"  />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" id="slipsumcommission" name="slipsumcommission" class="form-control form-control-sm money text-left " data-validation="length" data-validation-length="0-50"   />
                                                        <input type="text" id="slipsumcommission2" name="slipsumcommission2" class="form-control form-control-sm money text-left " data-validation="length" data-validation-length="0-50"   />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="input-group">
                                                                    <input type="text" id="slipvbroker" name="slipvbroker" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50" placeholder="a" />
                                                                    <div class="input-group-append">
                                                                        <div class="input-group-text"><i class="fa fa-percent" aria-hidden="true"></i></div> 
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="input-group">
                                                                    <input type="hidden"  id="slipsumfee" name="slipsumfee"  class="form-control form-control-sm money text-left " data-validation="length" data-validation-length="0-50"  />
                                                                    <input type="text"  id="slipsumfee2" name="slipsumfee"  class="form-control form-control-sm money text-left " data-validation="length" data-validation-length="0-50"   />
                                            ...
                                            <div class="row"> 
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" id="slipgrossprmtonr" name="slipgrossprmtonr" class="form-control form-control-sm money text-left " data-validation="length" data-validation-length="0-50" placeholder="a &permil;  * tsi * b%"  />
                                                        <input type="text" id="slipgrossprmtonr2" name="slipgrossprmtonr2" class="form-control form-control-sm money text-left " data-validation="length" data-validation-length="0-50"  disabled />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" id="slipnetprmtonr" name="slipnetprmtonr" class="form-control form-control-sm money text-left " data-validation="length" placeholder="=a &permil;. * b% * tsi * (100% - d%)" data-validation-length="0-50" />
                                                        <input type="text" id="slipnetprmtonr2" name="slipnetprmtonr2" class="form-control form-control-sm money text-left " data-validation="length"  data-validation-length="0-50" disabled/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                                ...
                                                                <tfoot>
                                                                    <tr>
                                                                        <form id="addinstallmentinsured">
                                                                            ...
                                                                            <td>
                                                                                <div class="form-group">
                                                                                    <input type="text" id="sliptotalpercentinspan" class="form-control form-control-sm money text-left" name="sliptotalpercentinspan" hidden="true" >
                                                                ...
                                                                <tfoot>
                                                                    ...
                                                                    @csrf   
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="form-group">
                                                                                    <input type="hidden" id="sliptotalpercentrpor" name="sliptotalpercentrpor" value="0">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="slipsumor2"  name="slipsumor2" class="form-control form-control-sm money text-left " data-validation="length" data-validation-length="0-50" disabled />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

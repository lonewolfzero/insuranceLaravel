                                              ...
                                              <div class="form-group">
                                                  <div class="row">
                                                      ...
                                                      <div class="col-md-4">
                                                          ...
                                                          <input type="text" name="hemsuffix" id='autocomplete2'  value="{{$insureddata->insured_suffix}}"  class="form-control form-control-sm " style="text-transform:uppercase;" maxlength="300" data-validation="length" data-validation-length="0-300" placeholder="suffix: QQ or TBk" required/>
                                              ...
                                              <div class="row">
                                                  ...
                                                  <div class="col-md-3">
                                                      <div class="form-group">
                                                          ...
                                                          <input id="hemsharefrom" type="text"  name="hemsharefrom" value="{{$insureddata->share_from}}"  class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50" readonly="readonly" />
                                                      </div>
                                                  </div>
                                                          ...
                                                          <div class="row">
                                                              <div class="col-md-10">
                                                                  <div class="input-group">
                                                                     <input type="text"  value="{{$insureddata->share}}"  id="hemshare"  name="hemshare" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-250" readonly/>
                                                                  </div>
                                                              </div>
                                                          </div>
                                                      </div>
                                                                                ...
                                                                                <th>Policy Number</th>
                                                                                      ...
                                                                                      <tbody id="tbcid{{ $slt->id }}">
                                                                                          ...
                                                                                          <tr id="riskdetailsid{{ $detaillocrisk->id }}">
                                                                                              ...
                                                                                              <td>{{ number_format($detaillocrisk->percentage,3,'.',',') }} %</td>
                                              ...
                                              <div class="row">
                                                  ...
                                                  <div class="col-md-3">
                                                      <div class="form-group">
                                                          ...
                                                          <input id="hemsharefrom" type="hidden" name="hemsharefrom" value="0"class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50"   />
                                                          <input id="hemsharefrom2" type="text" name="hemsharefrom2" value="0"class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50"  disabled />
                                                      </div>
                                                  </div>
                                                  ...
                                                  <div class="col-md-3">
                                                      <div class="form-group">
                                                          ...
                                                          <div class="row">
                                                              <div class="col-md-12">
                                                                  <div class="input-group">
                                                                      <input type="hidden" id="hemshare"  name="hemshare" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-250"  />
                                                                      <input type="text" id="hemshare2"  name="hemshare2" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-250" disabled />
                                                  ...
                                                  <div class="col-md-3">
                                                      <div class="form-group">
                                                          <label for="">{{__('Total Sum Insured')}}</label>
                                                          <input id="hemshareto2" type="text"  name="hemshareto" class="form-control form-control-sm money text-left" value="" data-validation="length" data-validation-length="1-50" />
                                                          <input id="hemshareto"  type="hidden" name="hemshareto" value="0" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50" />
                                                      </div>
                                                  </div>
                                              </div>
                                          </div>
...
@include('crm.transaction.facultative.js.header_hem_js')
@endsection
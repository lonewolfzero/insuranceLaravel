                              ...
                              <div class="row">
                                ...
                                <div class="col-md-4">
                                  ...
                                  <input type="text" name="fesuffix" id='autocomplete2' style="text-transform:uppercase;"
                                    value="{{ $insureddata->insured_suffix }}" class="form-control form-control-sm " maxlength="300" 
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-3">
                                <div class="form-group">
                                  ...
                                  <select id="fecurrency" name="fecurrency" class="e1 form-control form-control-sm " style="width:90%">
                              ...
                              <div class="col-md-3">
                                <div class="form-group">
                                  ...
                                  <input id="feshareto2" type="text" name="feshareto"
                                    value="{{ $insureddata->share_to}}"
                                    class="form-control form-control-sm money text-left" data-validation="length"
                                    data-validation-length="1-150" />
                                  <input id="feshareto" type="hidden" name="feshareto"
                                    value="{{ $insureddata->share_to }}"
                                    class="form-control form-control-sm money" data-validation="length"
                                    data-validation-length="0-150" />
                                </div>
                              </div>
                                                ...
                                                @if (!empty($slt->risklocationdetail))
                                                  ...
                                                  @foreach ($slt->risklocationdetail as $detaillocrisk)
                                                    ...
                                                    <tr id="riskdetailsid{{ $detaillocrisk->id }}">
                                                      ...
                                                      <td class="amount">
                                                        {{  number_format($detaillocrisk->amountlocation, 2, '.', ',') }}
                                                      </td>
                                                      <td>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <label for="" style="opacity: 0">{{__('insured 2')}}</label>
                                                        <input type="text" name="fesuffix" id='autocomplete2' style="text-transform:uppercase;" class="form-control form-control-sm " data-validation="length" maxlength="300"  data-validation-length="0-350" placeholder="suffix: QQ or TBk" />
                                                        <label class="text-right label-max"> 0 / 300</label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="">{{__('NASIONAL RE Share')}}</label>
                                                        <input id="fesharefrom" type="hidden"   name="fesharefrom" class="form-control form-control-sm money text-left" value="" data-validation="length" data-validation-length="0-50"   />
                                                        <input id="fesharefrom2" type="text"   name="fesharefrom2" class="form-control form-control-sm money text-left" value="" data-validation="length" data-validation-length="0-50"  disabled />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="input-group" lang="en-US">
                                                                    <input type="hidden" id="feshare" name="feshare" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-250"  />
                                                                    <input type="text" id="feshare2" name="feshare2" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-250" disabled />
                                                                    <!-- <div class="input-group-append">
                                                                        <div class="input-group-text"><i class="fa fa-percent" aria-hidden="true"></i></div> 
                                                                    </div> -->
                                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="">{{__('Total Sum Insured')}}</label>
                                                        {{-- <input id="feshareto2" type="text"  name="feshareto" class="form-control form-control-sm money " value="" data-validation="length" data-validation-length="1-250" /> --}}
                                                        <input id="feshareto" type="text"  name="feshareto" class="form-control form-control-sm money text-left" value="" data-validation="length" data-validation-length="1-250" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
@include('crm.transaction.facultative.js.header_fe_js')
@endsection
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-10">
                                                            <div class="input-group">
                                                             <input type="number" min="0"  value="{{$insureddata->share}}" step=".01" id="flshare" name="flshare" class="form-control form-control-sm amount" data-validation="length" data-validation-length="0-250" readonly/>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="postal_code_location_id"  class="e1 form-control form-control-sm" name="postal_code_location">
                                    </div>
                                </div>
                            </div>

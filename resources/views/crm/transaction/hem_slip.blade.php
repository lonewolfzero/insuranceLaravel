                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="input-group">
                                                                <input type="text" id="hemshare"  name="hemshare" class="form-control form-control-sm amount" data-validation="length" data-validation-length="0-250" readonly />
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="hemshareto2" type="text"  name="hemshareto" class="form-control form-control-sm amount insertins" value="" data-validation="length" data-validation-length="1-50" />
                                                            
                                                    <input id="hemshareto"  type="hidden" name="hemshareto" value="0" class="form-control form-control-sm amount" data-validation="length" data-validation-length="0-50" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="text-primary mr-3 float-right " data-toggle="modal" data-book-id="{{  @$slipdatatadetail->id }}" data-target="#cancelmodaldata">
                                         ...
                                         @include('crm.transaction.hem_slipupdate_claim_modal')

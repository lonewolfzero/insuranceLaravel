...
$(document).ready(function(){
    ...
    var currency_exc = $('#hemcurrency').val();
    if(currency_exc){
        $.ajax({
            type:"GET",
            url:"{{url('get-kurs-detail')}}?currency_id="+currency_exc,
...
<script type="text/javascript">
    ...
    $('#detailmodaldata').on('show.bs.modal', function(e) {
        ...
        $.ajax({
        url:'{{ url("/") }}/transaction-data/detailhemslip/'+codesl,
        type:"GET",
        beforeSend: function() { $("body").addClass("loading");  },
        complete: function() {  $("body").removeClass("loading"); },
    ...
    $('#updatemodaldata').on('show.bs.modal', function(e) {
        ...
        $.ajax({
            ...
            success:function(response)
            {
               ...
               $('#slipidupdate').val(response.id);
                console.log("id form " + response.id)

                console.log(response);

                console.log('intallment ' + response.sum_ippercent)
...
<script type="text/javascript">
    ...
    $('#endorsementmodaldata').on('show.bs.modal', function(e) {
        ...
        $.ajax({
            url:'{{ url("/") }}/transaction-data/detailhemendorsementslip/'+codesl,
            type:"GET",
            beforeSend: function() { $("body").addClass("loading");  },
            complete: function() {  $("body").removeClass("loading"); },
            success:function(response)
        ...
        e.preventDefault();
         ...
         $.ajaxSetup({
               ...
               $.ajax({
                 ...
                 success:function(response)
                 {
                    swal("Success!", "He & Motor Slip Update Status Cancelled", "success")
                    console.log(response)
                    ...
                    error: function (request, status, error) {
                        //alert(request.responseText);
                        swal("Error!", "He & Motor Slip Update Error", "Update Error");
                    }
                });
...
<script type="text/javascript">
    $('#hemshareto2').keyup(function(){
        var tsislip = $('#sliptotalsum').val();
        var typetsi = $('#sliptypetsi').val();
        
        $('#hemshareto').val($(this).val());
        console.log($('#hemshareto').val())
...
<script type='text/javascript'>
    $('#addinsuredsave-btn').click(function(e){
       ...
       if(hemsuggestinsured == '' || hemshareto == ''){
...
<script type='text/javascript'>
    $('#multi-file-upload-ajax').submit(function(e){
       ...
       var real_kurs = 1;
        ...
        var count_endorsement_ins = $('#hemcountendorsement').val();
       ...
       swal({
        ...
        if (result.value)
        {
            ...
            if(btnins == "Update")
            {
                            ...
                            if(tsislipval == new_instsi){
                                    ...
                                    $.ajax({
                                         ...
                                         data:{
                                           ...
                                           success:function(response)
                                           {
                                            swal("Success!", "He & Motor Slip Insert Success", "success")
                                            console.log(response)
                                        ...
                                        error: function (request, status, error) {
                                                //alert(request.responseText);
                                                swal("Error!", "He & Motor Slip Insert Error : " + request.responseText, "Insert Error");
                                            }
                                        });
                ...
                // var fescoinsurance = $('#hemcoinsurance').val();
                // var feuy = $('#hemuy').val();
                ...
                // success:function(response)
                // {
                //     //swal("Success!", "He & Motor Insert Success", "success")
                //     console.log(response)
                //     $('#hemcountendorsement').val(response.count_endorsement);
                //     var real_ceding_share = response.ceding_share.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
                //     $('#hemshare').val(real_ceding_share);
                ...
                // error: function (request, status, error) {
                //             //alert(request.responseText);
                //             swal("Error!", "He & Motor Insured Insert Error", "Insert Error");
                //         }
                // });
       ...
       console.log('count endorsement ' + count_endorsement_ins)
        ...
        if(current_percent >= '100'){
             $.ajaxSetup({
               ...
               $.ajax({
                 url:"{{url('transaction-data/hem-slip/updateform')}}",
                 type:"POST",
                 data:{
                     code_ms:code_ms,
                     slipid:slip_id,
                 ...
                 success:function(response)
                 {
                    swal("Success!", "He & Motor Slip Update Success", "success")
                    console.log(response)
...
<script type='text/javascript'>
    $('#multi-file-upload-ajaxendorsement').submit(function(e){
       ...
       $.ajax({
         ...
         success:function(response)
         {
            swal("Success!", "He & Motor Slip Endorsement Success", "success")
            console.log(response)

            // var insured_data2=JSON.parse(response.insured_data);
            // $('#hemcountendorsement').val(insured_data2.count_endorsement);
        ...
        error: function (request, status, error) {
            //alert(request.responseText);
            swal("Error!", "He & Motor Slip Endorsement Error", "Insert Error");
        }
       ...
       if(response){
        ...
        if(response.insured_data){
            ...
            for(var i = 0; i < insured_list.length; i++) 
            {
                ...
                $('#hemsinsured').val(obj.insured_prefix);
            ...
            swal("Failed!", "He & Motor Insured Data Endorsement Failed", "Endorsement Failed")
        }
        ...
        if(response.location_data){
                ...
                if(response.risklocation_data)
                {
                    ...
                    for(var i = 0; i < risklocation_list.length; i++) 
                    {
                        ...
                        $('#tcid'+obj2.id+' > tbody:last-child').empty();
                                ...
                                swal("Failed!", "He & Motor Risk Location Data Endorsement Failed", "Endorsement Failed")
                            }
                        ...
                        swal("Failed!", "He & Motor Location Data Endorsement Failed", "Endorsement Failed")
                    }
                    ...
                    if(response.slip_data){
                        ...
                        swal("Failed!", "He & Motor Slip Data Endorsement Failed", "Endorsement Failed")

                    }
                    window.location.replace("{{url('transaction-data/hem-slipindex')}}");
                    swal("Success!", "He & Motor Slip Endorsement Success", "Endorsement Success")

                }else{
                    swal("Error!", "He & Motor Slip Endorsement Data Error", "Endorsement Data Error");
                }
            ...
            error: function (request, status, error) {
                //alert(request.responseText);
                swal("Error!", "He & Motor Slip Endorsement Error", "Endorsement Error");
            }
        });

                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-10">
                                                            <div class="input-group">
                                                                <input type="text"  id="mpshare" name="mpshare" class="form-control form-control-sm amount" data-validation="length" data-validation-length="0-250" readonly="readonly"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="mpshareto2" type="text"  name="mpshareto" class="form-control form-control-sm amount insertins" value="" data-validation="length" data-validation-length="1-50" />
                                                    <input id="mpshareto"  type="hidden" name="mpshareto" value="0" class="form-control form-control-sm amount" data-validation="length" data-validation-length="0-50" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="text-primary mr-3 float-right " data-toggle="modal" data-book-id="{{  @$slipdatatadetail->id }}" data-target="#cancelmodaldata">
                                         ...
                                         @include('crm.transaction.mp_slipupdate_claim_modal')

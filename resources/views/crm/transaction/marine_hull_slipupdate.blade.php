                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="mhnumber" id="mhnumber" class="form-control form-control-sm" data-validation="length" data-validation-length="1-25" value="{{ $insureddata->number }}" readonly="readonly" required/>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" id="autocomplete" name="mhsuggestinsured" style="text-transform:uppercase;" value="{{ $insureddata->insured_name }}" class="form-control form-control-sm " data-validation="length" data-validation-length="0-350" placeholder="search for insured suggestion" required/>
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="" style="opacity: 0">{{__('insured 2')}}</label>
                                                    <input type="text" name="mhsuffix" id="autocomplete2" style="text-transform:uppercase;" value="{{ $insureddata->insured_suffix }}" class="form-control form-control-sm " data-validation="length" data-validation-length="0-350" placeholder="suffix: QQ or TBk" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="mhroutefrom" name="mhroutefrom"  value="{{ $insureddata->route_from }}" class="form-control form-control-sm " data-validation="length" data-validation-length="0-350" placeholder="*from" />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="" style="opacity: 0">{{__('a')}}</label>
                                                    <input type="text" id="mhrouteto" name="mhrouteto" value="{{ $insureddata->route_to }}" class="form-control form-control-sm " data-validation="length" data-validation-length="0-350" placeholder="*to" />
                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="input-group">
                                                                <input type="text" id="mhsharefrom" name="mhsharefrom" value="{{ strval(number_format($insureddata->share_from, 3, '.', ',')) }}" class="form-control form-control-sm " data-validation="length" data-validation-length="0-350" readonly="readonly" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="mhshare" name="mhshare" class="form-control form-control-sm " value="{{ strval(number_format($insureddata->share, 3, '.', ',')) }}" data-validation="length" data-validation-length="0-350" readonly="readonly" />
                                                </div>
                                            </div>
                                    ...
                                    @endforeach
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="mhshareto" name="msishareto" value="{{ strval(number_format($insureddata->share_to, 3, '.', ',')) }}" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-350" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-body">
                                                <div class="col-md-12 com-sm-12 mt-3">
                                                    <table id="shipdetailTable" class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                            @foreach($shiplist as $slt)
                                                                ...
                                                                <tr id="sid{{ $slt->id }}" data-name="shiplistvalue[]">
                                                                    ...
                                                                    <td>{{ @$slt->cedingdata->name }}</td>
                                                                    <td>@if ($slt->cndn){{ $slt->cndn }} @else - @endif</td>
                                                                    <td>@if ($slt->certno){{ $slt->certno }}@else - @endif</td>
                                                                    <td>@if ($slt->slipno){{ $slt->slipno }}@else - @endif</td>
                                                                    <td>@if ($slt->policyno){{ $slt->policyno }}@else - @endif</td>
                                                                    <td>{{ $slt->percent }} %</td>
                                                                    <td>@currency($slt->amount)</td>
                                                                    <td>
                                                        ...
                                                        @php
                                                            $totalPercent += $spc->percentage;
                                                            $totalAmount += $spc->amount;
                                                        @endphp
                                                          <tr id="totalamount">
                                                            <th colspan="2"></th>
                                                            <td colspan="5">{{$spc->name}}</td>
                                                            <td >{{strval(number_format($spc->percentage, 2, '.', ','))}}%</td>
                                                            <td >{{strval(number_format($spc->amount, 2, '.', ','))}}</td>
                                                          </tr>
                                                         @endforeach
                                                         <!-- <tr>
                                                            <th colspan="5">Total</th> 
                                                            <td colspan="3" class="text-right">{{strval(number_format($totalPercent, 2, '.', ','))}}%</td> 
                                                            <td colspan="3">{{strval(number_format($totalAmount, 2, '.', ','))}}</td> 
                                                         </tr> -->
                                                    </table>
                                                </div>
                                            </div>
                    ...
                    <div class="modal-body">
                        <div class="col-md-12 col-md-12">
                            <div class="form-group">
                                ...
                                <select name="shipcodetxt" id="shipcodetxt" class="form-control form-control-sm e1">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-md-12">
                                ...
                                <input type="text" name="shipnametxt" id="shipnametxt" class="form-control" value="" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 col-md-12">
                            <div class="form-group">
                                ...
                                <select id="mhcedinglist" name="mhcedinglist" class="e1 form-control form-control-sm ">
                                                                ...
                                                                <div class="col-md-12 com-sm-12 mt-3">
                                                                    ...
                                                                    <tbody>
                                                                        @foreach($conditionneededlist as $cnt)
                                                                            @if(!empty($cnt->conditionneeded->name))
                                                                            <tr id="cnid{{ $cnt->id }}">
                        ...
                        <div class="modal fade" id="ModalCountHull" tabindex="-1" user="dialog" aria-hidden="true">
                            <div class="modal-dialog" user="document">
                                ...
                                <form id="form-hulltypecount" >
                                    ...
                                    <div class="modal-body">
                                        <div class="col-md-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="mhtype" id="mhtype" class="form-control form-control-sm e1" style="width:100%">
                                                    <option selected disabled>{{__('Select Type')}}</option>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">{{__('Close')}}</button>
                                        <button type="submit" class="btn btn-info" id="addhulltype-btn">Add Count</button>
                                    </div>
                                </form>
                                </div>
                            </div>

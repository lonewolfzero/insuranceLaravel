                                ...
                                <div class="card-body bg-light-gray">
                                    <div class="tab-content p-0 pt-1" id="custom-tabs-three-tabContent">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="input-group">
                                                                            <input type="text" id="slippctendorsement" name="slippctendorsement" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50" placeholder="pct" />
                                                                            <div class="input-group-append">
                                                                ...
                                                                <div class="col-md-10">
                                                                    <div class="col-md-12 com-sm-12 mt-3">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="text" id="slipdppercentageendorsement" name="slipdppercentageendorsement" placeholder="x" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50" />
                                                                                    <div class="input-group-append">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="hidden" id="sliptotalrateendorsement" value="" name="sliptotalrateendorsement" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50"   />
                                                                <input type="text" id="sliptotalrateendorsement2" value="" name="sliptotalrateendorsement2" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50" disabled  />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="input-group">
                                                                            <input type="text"  id="slipshareendorsement" name="slipshareendorsement" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50"  />
                                                                            <div class="input-group-append">
                                                                                <div class="input-group-text"><i class="fa fa-percent" aria-hidden="true"></i></div> 
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="row d-flex flex-wrap">
                                                                    <div class="col-md-12">
                                                                        <div class="input-group">
                                                                            <input type="text" id="slipcommissionendorsement" name="slipcommissionendorsement" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50"  />
                                                                            <div class="input-group-append">
                                                                                <div class="input-group-text"><i class="fa fa-percent" aria-hidden="true"></i></div> 
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="input-group">
                                                                            <input type="text" id="slipvbrokerendorsement" name="slipvbrokerendorsement" class="form-control form-control-sm money text-left money text-left" data-validation="length" data-validation-length="0-50" placeholder="a" />
                                                                            <div class="input-group-append">
                                                                                <div class="input-group-text"><i class="fa fa-percent" aria-hidden="true"></i></div> 
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="input-group">
                                                                            <input type="hidden"  id="slipsumfeeendorsement" name="slipsumfeeendorsement"  class="form-control form-control-sm money text-left money text-left" data-validation="length" data-validation-length="0-50"  />
                                                                            <input type="text"  id="slipsumfeeendorsement2" name="slipsumfeeendorsement2"  class="form-control form-control-sm money text-left money text-left" data-validation="length" data-validation-length="0-50"  />
                                        ...
                                        <div class="tab-pane fade" id="installment-details-id3" role="tabpanel" aria-labelledby="installment-details">
                                                                ...
                                                                <div class="col-md-10">
                                                                    <div class="col-md-12 com-sm-12 mt-3">
                                                                        ...
                                                                        <tr>
                                                                           ...
                                                                           <td>
                                                                                <div class="form-group">
                                                                                <input type="text" class="form-control form-control-sm datepicker-input tanggal" value="" data-target="#date" id="slipipdateendorsement" name="slipipdateendorsement">
                                                                                </div>
                                                                            </td>
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="text"   id="slipippercentageendorsement" name="slipippercentageendorsement" placeholder="w" class="form-control form-control-sm money text-left" />
                                                                                    <div class="input-group-append">
                                                                                        <div class="input-group-text"><i class="fa fa-percent" aria-hidden="true"></i>
                                                                                    </div>
                                                                                </div>
                                            ...
                                            <input type="hidden" id="sliptotalpercentrporendorsement" name="sliptotalpercentrporendorsement" value="0">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="input-group">
                                                                        <input type="text" id="sliporendorsement" value="" name="sliporendorsement" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50"/>
                                                                        <div class="input-group-append">
                                                                            <div class="input-group-text"><i class="fa fa-percent" aria-hidden="true"></i></div> 
                                                                        </div>
                                                                    </div>
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="form-group">
                                                                                            <div class="row">
                                                                                                <div class="col-md-10">
                                                                                                    <div class="input-group">
                                                                                                        <input type="text" id="sliprppercentageendorsement" name="sliprppercentageendorsement" class="form-control form-control-sm money text-left" />
                                                                                                        <div class="input-group-append">
                                                                                                            <div class="input-group-text"><i class="fa fa-percent" aria-hidden="true"></i></div> 
                                                                                                        </div>
                                                                                                    </div>

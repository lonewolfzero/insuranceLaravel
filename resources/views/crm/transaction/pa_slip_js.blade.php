...
<script>
    ...
    { 
        ...
        $("#tabretro").attr('hidden','true');
            ...
            // $('#pashareto2 .insertins').prop("disabled", false);
            // var tbl_long = document.getElementById("locRiskTable").rows.length;
            // console.log(tbl_long)
            // if(tbl_long < 2){
            //     var attr = $('#pashareto2 .insertins').prop("disabled", true);
            //     if(typeof attr !== typeof undefined && attr !== false){
            //         $('#pashareto2 .insertins').prop("disabled", false);
            //     }
            // }else if(tbl_long > 1){
            //     $('#pashareto2 .insertins').prop("disabled", true);
            // }
            ...
            var currency_exc = $('#pacurrency').val();
            if(currency_exc){
                $.ajax({
                    type:"GET",
...
<script type="text/javascript">
    ...
    $('#detailmodaldata').on('show.bs.modal', function(e) {
        ...
        $.ajax({
        url:'{{ url("/") }}/transaction-data/detailpaslip/'+codesl,
        type:"GET",
        beforeSend: function() { $("body").addClass("loading");  },
        complete: function() {  $("body").removeClass("loading"); },
...
<script type="text/javascript">
    ...
    $('#endorsementmodaldata').on('show.bs.modal', function(e) {
        ...
        $.ajax({
            url:'{{ url("/") }}/transaction-data/detailendorsementpaslip/'+codesl,
            type:"GET",
            beforeSend: function() { $("body").addClass("loading");  },
            complete: function() {  $("body").removeClass("loading"); },
            success:function(response)
                ...
                if(sliprate != null){
                    ...
                    if(grossprm_to_nr != null){
                        ...
                        console.log('nre' + nasionalreinsurance)
                            ...
                            // $('#pashare').val(sumourshare.replace(/,/g, "."));
        ...
        if(choice == '1'){
            ...
            if(shareslipval != null){
                ...
                if(sliprate != null){
                    ...
                    if(grossprm_to_nr != null){
                        var nasionalreinsurance =  $('#pasharefromendorsement').val();
                        var totalnre =  $('#pasharetoendorsement').val();
                        var conv_totalnre =  parseInt(totalnre.replace(/,/g, ""));
                ...
                if(sliprate != null){
                    ...
                    if(grossprm_to_nr != null){
                        ...
                        console.log('nre' + nasionalreinsurance)
                            ...
                            $('#slipsumorupdate2').val(real_sumor);
                            // $('#pashare').val(sumourshare.replace(/,/g, "."));
                            $('#pasharefromupdate').val(real_sumnre);
        ...
        $.ajax({
            ...
            success:function(response){
                console.log(response)
                    ...
                    // var tsicheck = $('#pashareto2').val();
                    // if(tsicheck != null){
                    //     $('#pashareto2').prop("disabled", true);
                    // }
    ...
    $.ajax({
        ...
        success:function(response){
            ...
            $('#cid'+id).remove();
                ...
                // if(tbl_long < 2){
                //     var attr = $('#pashareto2').prop("disabled", true);
                //     if(typeof attr !== typeof undefined && attr !== false){
                //         $('#pashareto2').prop("disabled", false);
                //     }
                // }else if(tbl_long > 1){
                //     $('#pashareto2').prop("disabled", true);
                // }
                ...
                success:function(response){
                    console.log(response)
                        ...
                        if(ceding_share == ''){
                            ...
                            $('#pashare').val(conv_sum_ceding);
                            $('#pashare2').val(conv_sum_ceding);
...
function deletelocationriskdetail(id){
    ...
    $.ajax({
        ...
        success:function(response){
            ...
            // $('#pashareto').val(real_sumtotalnre);
...
<script type="text/javascript">
    $('#pashareto2').keyup(function(){
        var tsislip = $('#sliptotalsum').val();
        var typetsi = $('#sliptypetsi').val();
        
        $('#pashareto').val($(this).val());
        console.log($('#pashareto').val())
   ...
   $('#slipshareendorsement').change(function (e) {
        if(e.keyCode != 9){
            if($(this).val() < -100 || $(this).val() > 100){
                ...
                $('#slipsumorendorsement2').val(real_sumor);
                // $('#pashare').val(sumourshare.replace(/,/g, "."));
                $('#pasharefromendorsement').val(real_sumnre);
...
<script type='text/javascript'>
    $('#addinsuredsave-btn').click(function(e){
       ...
       var fesinsured = $('#painsured').val();
       var fessuggestinsured = $('#autocomplete').val();
       var fessuffix = $('#autocomplete2').val();
       var fesshare = $('#pashare').val();
       var fessharefrom  = $('#pasharefrom').val();
       var fesshareto = $('#pashareto').val();
       var fescoinsurance = $('#pacoinsurance').val();
       var feuy = $('#pauy').val();
       var fecurrency = $('#pacurrency').val();
       var attachfile = $('#paattachment').val();
    ...
    if(fessuggestinsured == '' || fesshareto == ''){
        ...
        $.ajax({
         ...
         success:function(response)
         {
            swal("Success!", "Personal Accident Insured Insert Success", "success")
            console.log(response)
            // $('#pacountendorsement').val(response.count_endorsement);
            var real_ceding_share = response.ceding_share.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
            $('#pashare').val(real_ceding_share);
        ...
        error: function (request, status, error) {
                    //alert(request.responseText);
                    swal("Error!"+ request.responseText , "Personal Accident Insured Insert Error, please check input", "Insert Error");
                }
            });

        var formData = new FormData(this);
        let TotalFiles = $('#paattachment')[0].files.length; //Total files
        let files = $('#paattachment')[0];
        var status = 'passive';
        var insured_id = $('#insuredIDtxt').val();
        var sliptype = 'pa';
        ...
        if(TotalFiles > 0){
            ...
            $.ajax({
                type:'POST',
                url: "{{ url('store-insured-file-ajax')}}",
                data: formData,
                cache:false,
                contentType: false,
                processData: false,
...
<script type='text/javascript'>
    $('#multi-file-upload-ajax').submit(function(e){
       ...
       var count_endorsement_ins = $('#pacountendorsement').val();
                    ...
                    if(parseInt(jumlah_tgl) > 0){
                        ...
                        if(type_tsi == 1){
                            ...
                            if(tsislipval == new_instsi){
                                    ...
                                    $.ajax({
                                         url:"{{url('transaction-data/pa-slip/store')}}",
                                         type:"POST",
                                         data:{
                                           ...
                                           success:function(response)
                                           {
                                            swal("Success!", "Personal Accident Slip Insert Success", "success")
                                            console.log(response)
                                            ...
                                            // $('#pashare').val(response.ourshare);
                                            // $('#pasharefrom').val(response.sumshare);
                                        ...
                                        error: function (request, status, error) {
                                                //alert(request.responseText);
                                                swal("Error!", " Personal Accident Slip Insert Error : " + request.responseText, "Insert Error");
                                            }
                                        });
                            ...
                            if(tsislipval == new_cedshareins){
                                    ...
                                    $.ajax({
                                        ...
                                        error: function (request, status, error) {
                                                //alert(request.responseText);
                                                swal("Error!", "Insured Personal Accident Slip Insert Error : " + request.responseText, "Insert Error");
                                            }
                                        });
        ...
        if(parseFloat(current_percent) == 100.00)
            {
             $.ajaxSetup({
               ...
               $.ajax({
                 url:"{{url('transaction-data/pa-slip/updateform')}}",
                 type:"POST",
                 data:{
                     code_ms:code_ms,
                     slipnumber:slipnumber,
...
<script type='text/javascript'>
    $('#multi-file-upload-ajaxendorsement').submit(function(e){
       ...
       $.ajax({
         url:"{{url('transaction-data/pa-slip/endorsementstore')}}",
         type:"POST",
         data:{
             slipid:slipid,
             code_ms:code_ms,
         ...
         success:function(response)
         {
            ...
            // $('#pacountendorsement').val(insured_data2.count_endorsement);
       ...
       if(response){
        ...
        if(response.insured_data){
            ...
            for(var i = 0; i < insured_list.length; i++) 
            {
                ...
                $('#pasnumber').val(obj.number);
                $('#pasinsured').val(obj.insured_prefix);
                $('#autocomplete').val(obj.insured_name);
                $('#autocomplete2').val(obj.insured_suffix);
                $('#pashare').val(obj.share);
                $('#pasharefrom').val(obj.share_from);
                $('#pauy').val(obj.uy);
                $('#pashareto').val(obj.share_to);

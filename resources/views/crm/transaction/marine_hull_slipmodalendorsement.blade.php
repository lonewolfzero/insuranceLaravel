<div class="modal fade" id="endorsementmodaldata" tabindex="-1" user="dialog" aria-labelledby="addendorsementLabel" aria-hidden="true">
                ...
                <div class="modal-content bg-light-gray">
                    ...
                    @csrf
                                ...
                                <div class="card-body bg-light-gray">
                                    <div class="tab-content p-0 pt-1" id="custom-tabs-three-tabContent">
                                                                            ...
                                                                            <tbody>
                                                                                 <tr>
                                                                                    <form id="addconditionneeded">
                                                                                        ...
                                                                                        <td>
                                                                                            <div class="form-group">
                                                                                                <button type="button" class="btn btn-md btn-primary" id="addconditionneededendorsement-btn">{{__('Add')}}</button>
                                                                                            </div>
                                                                                        </td>
                                                                                    </form>
                                                                                </tr>
                                                        ...
                                                        <div class="card-header bg-gray">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <button id="addhullcountendorsement-btn" type="button" class="btn btn-sm btn-primary float-right" data-toggle="modal" data-target="#ModalCountHullEndorsement">{{__('Add')}}</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12 com-sm-12">
                                                                    <table id="marineHullCountTableEndorsement" class="table table-bordered table-striped">
                                                                        <thead>
                                                                            <tr>
                                                                                <th>{{__('Type')}}</th>
                                                                                <th>{{__('Share %')}}</th>
                                                                    ...
                                                                    <table id="marineHullCountTableEndorsement2" class="table table-bordered table-striped">
                                                                        <tbody>
                                                                            <tr id="totalhullendorsement">
                                                                                <th>Total</th>
                                                                                ...
                                                                                <th><!-- <div class="input-group">
                                                                                            <input type="text"  id="totalhullshare" readonly="true" name="totalhullshare" class="form-control form-control-sm " data-validation="length" data-validation-length="0-50"  />
                                                                                            <div class="input-group-append">
                                                                                                <div class="input-group-text"><i class="fa fa-percent" aria-hidden="true"></i></div> 
                                                                                            </div>
                                                                                        </div> -->
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="hidden" id="slipgrossprmtonrendorsement" name="slipgrossprmtonrendorsement" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50" placeholder="a %  * tsi * b%"  />
                                                                <input type="text" id="slipgrossprmtonrendorsement2" name="slipgrossprmtonrendorsement2" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50" placeholder="a % * tsi * b% " disabled />
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="hidden" id="slipsumcommissionendorsement" name="slipsumcommissionendorsement" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50" placeholder="= a % * b% * tsi * (100% - d%)"  />
                                                                <input type="text" id="slipsumcommissionendorsement2" name="slipsumcommissionendorsement2" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50" placeholder="= a % * b% * tsi * (100% - d%)" />
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="input-group">
                                                                            <input type="text" id="slipvbrokerendorsement" name="slipvbrokerendorsement" value="0" class="form-control form-control-sm money text-left " data-validation="length" data-validation-length="0-50" placeholder="a" />
                                                                            <div class="input-group-append">
                                                                                <div class="input-group-text"><i class="fa fa-percent" aria-hidden="true"></i></div> 
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="input-group">
                                                                            <input type="hidden"  id="slipsumfeeendorsement" name="slipsumfeeendorsement"  class="form-control form-control-sm money text-left " data-validation="length" data-validation-length="0-50" placeholder="= a % * b% * tsi * (100% - e%)" />
                                                                            <input type="text"  id="slipsumfeeendorsement2" name="slipsumfeeendorsement"  class="form-control form-control-sm money text-left " data-validation="length" data-validation-length="0-50"  placeholder="= a % * b% * tsi * (100% - e%)" />
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" id="slipnetprmtonrendorsement" name="slipnetprmtonrendorsement" class="form-control form-control-sm money text-left" data-validation="length" placeholder="=a % * b% * tsi * (100% - d%)" data-validation-length="0-50" />
                                                        <input type="text" id="slipnetprmtonrendorsement2" name="slipnetprmtonrendorsement2" class="form-control form-control-sm money text-left" data-validation="length" placeholder="= a % * b% * tsi * (100% - d% - e%)" data-validation-length="0-50" disabled/>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="installment-details-id3" role="tabpanel" aria-labelledby="installment-details">
                                                                           ...
                                                                           <td>
                                                                            ...
                                                                            <td>
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" id="sliptotalamountinspanendorsement" name="sliptotalamountinspanendorsement" hidden="true" >
                                            ...
                                            <input type="hidden" id="sliptotalpercentrporendorsement" value="0" name="retropercent">
                                            ...
                                            <input type="hidden" id="slipor" value="100" name="slipor" class="form-control form-control-sm " data-validation="length" data-validation-length="0-50" />
                            ...
                            <div class="modal fade" id="ModalCountHullEndorsement" tabindex="-1" user="dialog" aria-hidden="true">
                            <div class="modal-dialog" user="document">
                                <div class="modal-content bg-light-gray">
                                <div class="modal-header bg-gray">
                                    <h5 class="modal-title">{{__('Marine Hull Premium Detail')}}</h5>
                                    <button type="button" class="close" id="modalcountendorsementbuttonclose" data-dismiss="modal3" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <form id="form-hulltypecountendorsement" >
                                    @csrf
                                    <div class="modal-body">
                                        <div class="col-md-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="mhtypeendorsement" id="mhtypeendorsement" class="form-control form-control-sm e1">
                                                ...
                                                <input type="hidden" id="hulltypehiddenendorsement" class="form-control form-control-sm " >
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="input-group" lang="en-US">
                                                                <input type="text" id="mhtypeshareendorsement" name="mhtypeshareendorsement"  class="form-control form-control-sm " data-validation="length" data-validation-length="0-50"  />
                                                                <div class="input-group-append">
                                                                    <div class="input-group-text"><i class="fa fa-percent" aria-hidden="true"></i></div> 
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="mhtypeamountendorsement" name="mhtypeamountendorsement" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50"  />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-md-12">
                                                ...
                                                <input type="text" name="mhtyperateendorsement" id="mhtyperateendorsement" class="form-control form-control-sm " value="" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="mhtypepremiendorsement" name="mhtypepremiendorsement" class="form-control form-control-sm money text-left" value="" />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" id="modalcountendorsementbuttonclose2" data-dismiss="modal3">{{__('Close')}}</button>
                                        <button type="button" class="btn btn-info" id="addhulltypeendorsement-btn">Add Count</button>
                                    </div>
                                </form>
                                </div>
                            </div>

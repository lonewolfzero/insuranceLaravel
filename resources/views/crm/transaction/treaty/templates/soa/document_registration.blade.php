        ...
        <div class="col-md-6">
          <div class="row">
            ...
            <div class="col-md-6"><input type="text" class="form-control form-control-sm" name="reg_number"
                id="reg_num_reg_number" readonly @if(@$soa) value="{{ @$soa->registration->reg_number }}" @endif></div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="row">
            ...
            <div class="col-md-6"><input type="text" name="date_of_doc" id="reg_num_date_of_doc"
                class="form-control form-control-sm datemask datepicker" autocomplete="off" required @if(@$soa)
                value="{{ date('d/m/Y',strtotime(@$soa->registration->date_of_doc)) }}" @endif>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <select name="ceding_broker" id="reg_num_ceding_broker"
                ...
                @foreach ($ceding as $c)
                @if ($c->id == @$soa->registration->ceding_broker)
        ...
        <div class="col-md-6">
          <div class="row">
            ...
            <div class="col-md-6"><input type="text" class="form-control form-control-sm datemask datepicker"
                name="incoming_date" id="reg_num_incoming_date" autocomplete="off" required @if(@$soa)
                value="{{ date('d/m/Y',strtotime(@$soa->registration->incoming_date)) }}" @endif>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <select name="ceding_company" id="reg_num_ceding_company"
                ...
                @foreach ($ceding as $c)
                @if ($c->id == @$soa->registration->ceding_company)
                <option value="{{ $c->id }}" selected>{{ $c->name }}
                  @else
                <option value="{{ $c->id }}">{{ $c->name }}</option>
                @endif
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <select name="period" id="reg_num_period" class="form-control form-control-sm" autocomplete="off"
                ...
                <option value="1" @if(@$soa->registration->period == "1") selected @endif>1ST</option>
                <option value="2" @if(@$soa->registration->period == "2") selected @endif>2ND</option>
                <option value="3" @if(@$soa->registration->period == "3") selected @endif>3RD</option>
                <option value="4" @if(@$soa->registration->period == "4") selected @endif>4TH</option>
              </select>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="row">
            ...
            <div class="col-md-6"><input type="text" class="form-control form-control-sm" name="ref_number"
                id="reg_num_ref_number" autocomplete="off" required @if(@$soa)
                value="{{ @$soa->registration->ref_number }}" @endif>
            </div>
          </div>
        </div>
        <div class="col-md-6">
          <div class="row">
            ...
            <div class="col-md-2"><input type="text" name="accounting_year" id="reg_num_accounting_year"
                autocomplete="off" class="form-control form-control-sm yearmask yearpicker" required @if(@$soa)
                value="{{ @$soa->registration->accounting_year }}" @endif>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <select name="delivered_by" id="reg_num_delivered_by" class="form-control form-control-sm"
                ...
                <option value="" selected></option>
                <option value="post" @if(@$soa->registration->delivered_by == "post") selected @endif>Post
                </option>
                <option value="email" @if(@$soa->registration->delivered_by == "email") selected
                  @endif>Email</option>
                <option value="fax" @if(@$soa->registration->delivered_by == "fax") selected @endif>Fax
                </option>
                <option value="copied" @if(@$soa->registration->delivered_by == "copied") selected
                  @endif>Copied from
                  other</option>
              </select>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <select name="type" id="reg_num_type" class="form-control form-control-sm" autocomplete="off" required>
                {{-- <option value="" selected></option> --}}
                {{-- <option value="pc" @if(@$soa->registration->type == "pc") selected @endif>Profit Commission
                </option> --}}
                <option value="soa" selected>Statement Of Account</option>
              </select>
            </div>
          </div>
        </div>

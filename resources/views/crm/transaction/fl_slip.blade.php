                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" name="flsuffix" id='autocomplete2' class="form-control form-control-sm " style="text-transform:uppercase;" data-validation="length" data-validation-length="0-50" placeholder="suffix: QQ or TBk" />
                                                ...
                                                <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="input-group">
                                                                        <input type="number" id="flshare" min="0" value="0" step=".01" name="flshare" class="form-control form-control-sm amount" data-validation="length" data-validation-length="0-250" readonly />
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="flshareto2" type="text"  name="flshareto" class="form-control form-control-sm amount insertins" value="" data-validation="length" data-validation-length="1-50" />
                                                            <input id="flshareto"  type="hidden" name="flshareto" value="0" class="form-control form-control-sm amount" data-validation="length" data-validation-length="0-50" />
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" id="flcountendorsement" name="flcountendorsement" class="form-control form-control-sm " data-validation="length"  data-validation-length="0-12" readonly="readonly"/>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="text-primary mr-3 float-right " data-toggle="modal" data-book-id="{{  @$slipdatatadetail->id }}" data-target="#cancelmodaldata">
                                         ...
                                         @include('crm.transaction.fl_slipupdate_claim_modal')
                                    ...
                                    <div class="card-body bg-light-gray">
                                        <div class="tab-content p-0 pt-1" id="custom-tabs-three-tabContent">
                                                                                    ...
                                                                                    <table id="ExtendCoveragePanel" class="table table-bordered table-striped">
                                                                                        ...
                                                                                        <tfoot>
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                    <div class="form-group">
                                                                                                        <input type="text" id="slipnilaiec" name="slipnilaiec" placeholder="y &permil;" class="form-control form-control-sm floatTextBox"/>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text"  id="sliprate" name="sliprate" class="form-control form-control-sm floatTextBox" data-validation="length" data-validation-length="0-50" placeholder="" />
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for=""  >{{__('Total Rate') }}</label>
                                                                            <input type="hidden" id="sliptotalrate" value="" name="sliptotalrate" class="form-control form-control-sm floatTextBox" data-validation="length" data-validation-length="0-50"  placeholder="= a &permil; * sum y &permil; " />
                                                                            <input type="text" id="sliptotalrate2" value="" name="sliptotalrate2" class="form-control form-control-sm floatTextBox" data-validation="length" data-validation-length="0-50" disabled placeholder="= a &permil;(rate + sum(permil&permil; extend coverage ))" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" id="slipsumcommission2" name="slipsumcommission2" class="form-control form-control-sm amount" data-validation="length" data-validation-length="0-50" placeholder="= a &permil; * b% * tsi * (100% - d%)"  />
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="input-group">
                                                                                        <input type="hidden"  id="slipsumfee" name="slipsumfee"  class="form-control form-control-sm amount" data-validation="length" data-validation-length="0-50" placeholder="= a &permil; * b% * tsi * (100% - e%)" />
                                                                                        <input type="text"  id="slipsumfee2" name="slipsumfee"  class="form-control form-control-sm amount" data-validation="length" data-validation-length="0-50"  placeholder="= a &permil; * b% * tsi * (100% - e%)" />
                                            ...
                                            <div class="tab-pane fade" id="installment-details-id" href="#installment-details-id" role="tabpanel" aria-labelledby="installment-details">
                                                ...
                                                <div class="row" id="tabretro" hidden="true">
                                                    <div class="col-md-12">
                                                        <div class="card">
                                                            <div class="card-header bg-gray">
                                                ...
                                                <div class="card card-primary">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-12 com-sm-12 mt-3">
                                                                <button type="submit" id="addslipinsured-btn" class="btn btn-primary btn-block ">Save</button>
                                                            </div>

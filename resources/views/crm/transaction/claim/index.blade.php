                    ...
                    <div class="row">
                      <div class="col-md-3 d-flex">
                        <input type="hidden" name="slipnumberdata" id="slipnumberdata" class="form-control"
                          autocomplete="off" placeholder="Slip Number" disabled>
                        <button type="button" id="prevbutton" name="prevbutton" class="btn btn-primary mx-2">{{
                          __('Prev') }}</button>
                        <button type="button" id="nextbutton" name="nextbuttpm" class="btn btn-primary">{{ __('Next')
                          }}</button>
                      ...
                      <div class="col-md-9 d-flex justify-content-end">
                        <select id="printdocument" name="printdocument" class="form-control mr-2"
                          ...
                          <option value="" selected disabled>Print Document</option>
                        ...
                        <button class="btn btn-sm btn-primary mr-2" style="display: none" id="buttonprintdocument">

<div class="modal fade" id="detailmodaldata" tabindex="-1" user="dialog" aria-labelledby="addDetailLabel"
  aria-hidden="true">
  <div class="modal-dialog" style="max-width: 80rem;" user="document">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" id="slipnumberdetail" name="slipnumberdetail"
                            class="form-control form-control-sm" value="" readonly="readonly" required />
                        </div>
                      </div>
                    </div>
                    <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <select id="slipcedingbrokerdetail" disabled="true" name="slipcedingbrokerdetail"
                      ...
                      <option value="{{ $cb->id }}">{{ $cb->type }} - {{ $cb->code }} -
                        {{ $cb->name }}</option>
                      @endforeach
                    </select>
                  </div>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <select id="slipcurrencydetail" disabled="true" name="slipcurrencydetail"
                          ...
                          <option value="{{ $crc->id }}" hidden="true">{{ $crc->code }} -
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <select id="slipcobdetail" name="slipcobdetail" disabled="true"
                          ...
                          <option value="{{ $boc->id }}">{{ $boc->code }} - {{ $boc->description }}
                          </option>
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <select id="slipkocdetail" name="slipkocdetail" disabled="true"
                          ...
                          <option value="{{ $cok->id }}">{{ $cok->code }} - {{ $cok->description }}
                          </option>
                ...
                <div class="col-md-4">
                  <div class="form-group d-flex justify-content-end">
                    ...
                    <button type="button" id="btnaddlayerdetail" class="btn plus-button" data-toggle="modal"
                      ...
                      <span data-toggle="tooltip" data-placement="top" title="{{ __('Add New layer') }}"> + add
                        layer
                      </span>
                    </button>
                  </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="sharetotalsumdetail" value="" name="sharetotalsumdetail"
                          class="form-control form-control-sm amount" data-validation="length"
                          data-validation-length="0-50" disabled placeholder="tsi(*total/sum from interest insured)" />
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" disabled="true" id="slipratedetail" name="slipratedetail"
                          class="form-control form-control-sm floatTextBox2" data-validation="length"
                          data-validation-length="0-50" placeholder="a &permil;" />
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="slipsumcommissiondetail2" name="slipsumcommissiondetail2"
                          class="form-control form-control-sm amount" data-validation="length"
                          data-validation-length="0-50" placeholder="= a &permil; * b% * tsi * (100% - d%)" disabled />
                      </div>
                    </div>
                          ...
                          <div class="col-md-12">
                            <div class="input-group">
                              <input type="text" disabled="true" id="slipvbrokerdetail" name="slipvbrokerdetail"
                                value="0" class="form-control form-control-sm floatTextBox" data-validation="length"
                                data-validation-length="0-50" placeholder="a" />
                              <div class="input-group-append">
                                <div class="input-group-text"><i class="fa fa-percent" aria-hidden="true"></i></div>
                              </div>
                          ...
                          <div class="col-md-12">
                            <div class="input-group">
                              <input type="hidden" id="slipsumfeedetail" name="slipsumfeedetail"
                                class="form-control form-control-sm " data-validation="length"
                                data-validation-length="0-50" placeholder="= a &permil; * b% * tsi * (100% - e%)" />

  ...
  <div class="modal-dialog modal-xl" user="document">
    <div class="modal-content bg-light-gray">
      <div class="modal-header bg-gray">
        ...
        <button class="btn btn-warning position-absolute" style="right: 7%" id="claimbutton" data-dismiss="modal"
          aria-label="Close">Claim</button>
      ...
      <form id="multi-file-upload-ajaxdetail" method="POST" action="javascript:void(0)" accept-charset="utf-8"
        ...
        <div class="card card-tabs">
            ...
            <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link active" id="slip-details2" data-toggle="pill" href="#slip-details-id2" role="tab"
                  aria-controls="slip-details-id" aria-selected="true">{{ __('Insured & Ship') }}</a>
              </li>
          ...
          <div class="card-body bg-light-gray">
            ...
            <div class="tab-content p-0 pt-1" id="custom-tabs-three-tabContent">
              <div class="tab-pane fade show active" id="slip-details-id2" role="tabpanel"
                aria-labelledby="slip-details">
                <div class="card">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <label for="">{{__('Number')}} </label>
                          <input type="text" id="numberslipdetail" name="numberslipdetail"
                            class="form-control form-control-sm" disabled />
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="text" value="" id="sliptotalsumpctdetail" name="sliptotalsumpctdetail"
                          class="form-control form-control-sm amount" data-validation="length"
                          data-validation-length="0-50" placeholder="=pct*tsi" readonly="readonly" />
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-md-5">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm datetimepicker-input" readonly="readonly"
                          value="" data-target="#date" id="sliprpfromdetail" name="sliprpfromdetail">
                    ...
                    <div class="card-body">
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="">{{__('TSI/Ceding Share') }}</label>
                            <select id="sharetypetsidetail" name="sharetypetsidetail"
                              class="form-control form-control-sm ">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="">{{__('TSI/Ceding Share Value') }}</label>
                            <input type="hidden" id="sharetotalsumdetail" value="" name="sharetotalsumdetail"
                              class="form-control form-control-sm amount" data-validation="length"
                              data-validation-length="0-50" placeholder="tsi(*total/sum from interest insured)" />
                            <input type="text" id="sharetotalsumdetail2" value="" name="sharetotalsumdetail2"
                              class="form-control form-control-sm amount" data-validation="length"
                        ...
                        <div class="col-md-12 com-sm-12">
                          <table id="marineHullCountTableDetail" class="table table-bordered table-striped">
                            ...
                            <tr id="totalhulldetail">
                              ...
                              <th>
                                <!-- <div class="input-group">
                                                                          <input type="text"  id="totalhullshare" readonly="true" name="totalhullshare" class="form-control form-control-sm floatTextBox" data-validation="length" data-validation-length="0-50" placeholder="b%" />
                                                                          <div class="input-group-append">
                                                                              <div class="input-group-text"><i class="fa fa-percent" aria-hidden="true"></i></div> 
                                                                          </div>
                                                                      </div> -->
                              </th>
                              <th><input type="hidden" id="totalhullwardetail"
                                  class="form-control form-control-sm amount" name="" readonly="true"></th>
                              <th><input type="hidden" id="totalhullhmivdetail" name="" readonly="true"></th>
                              <th><input type="text" id="totalhullpremidetail"
                                  class="form-control form-control-sm amount" name="" readonly="true"></th>
                ...
                <div class="col-md-12">
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="input-group">
                              <input type="text" id="slipsharedetail" name="slipsharedetail"
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input type="hidden" id="slipgrossprmtonrdetail" name="slipgrossprmtonrdetail"
                          class="form-control form-control-sm amount" data-validation="length"
                          data-validation-length="0-50" placeholder="a %  * tsi * b%" />
                        <input type="text" id="slipgrossprmtonrdetail2" name="slipgrossprmtonrdetail2"
                          class="form-control form-control-sm amount" data-validation="length"
                          data-validation-length="0-50" placeholder="a % * tsi * b% " disabled />
                      </div>
                    </div>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        <label for="">{{__('Nasional RE Share')}}</label>
                        <input type="hidden" id="slipsumsharedetail" name="slipsumsharedetail" placeholder="= b% * tsi"
                          class="form-control form-control-sm amount" data-validation="length"
                          data-validation-length="0-50" />
                        <input type="text" id="slipsumsharedetail2" name="slipsumsharedetail2" placeholder="= b% * tsi"
                          class="form-control form-control-sm amount" data-validation="length"
                          data-validation-length="0-50" disabled />
                      </div>
                    </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="row d-flex flex-wrap">
                          <div class="col-md-12">
                            <div class="input-group">
                              <input type="text" id="slipcommissiondetail" name="slipcommissiondetail"
                                class="form-control form-control-sm floatTextBox" data-validation="length"
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="hidden" id="slipsumcommissiondetail" name="slipsumcommissiondetail"
                          class="form-control form-control-sm amount" data-validation="length"
                          data-validation-length="0-50" placeholder="= a % * b% * tsi * (100% - d%)" />
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="input-group">
                              <input type="text" id="slipvbrokerdetail" name="slipvbrokerdetail" value="0"
                                class="form-control form-control-sm floatTextBox" data-validation="length"
                                data-validation-length="0-50" placeholder="a" />
                              <div class="input-group-append">
                                <div class="input-group-text"><i class="fa fa-percent" aria-hidden="true"></i></div>
                          ...
                          <div class="col-md-12">
                            <div class="input-group">
                              <input type="hidden" id="slipsumfeedetail" name="slipsumfeedetail"
                                class="form-control form-control-sm amount" data-validation="length"
                                data-validation-length="0-50" placeholder="= a % * b% * tsi * (100% - e%)" />
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="hidden" id="slipnetprmtonrdetail" name="slipnetprmtonrdetail"
                      class="form-control form-control-sm amount" data-validation="length"
                      placeholder="=a % * b% * tsi * (100% - d%)" data-validation-length="0-50" />
                    <input type="text" id="slipnetprmtonrdetail2" name="slipnetprmtonrdetail2"
                      class="form-control form-control-sm amount" data-validation="length"
                      placeholder="= a % * b% * tsi * (100% - d% - e%)" data-validation-length="0-50" disabled />
                  </div>
                </div>
              </div>
                  ...
                  <div class="row">
                    <div class="form-group">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="input-group">
                            <input type="text" id="slipordetail" readonly="readonly" value="" name="slipordetail"
                              class="form-control form-control-sm " data-validation="length"
                              data-validation-length="0-50" />
                            <div class="input-group-append">
                              <div class="input-group-text"><i class="fa fa-percent" aria-hidden="true"></i></div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <input type="text" id="slipsumordetail" value="" name="slipsumordetail"
                              class="form-control form-control-sm amount" data-validation="length"
                              data-validation-length="0-50" readonly />
                          </div>
                        </div>
                      </div>
                    </div>
    ...
    <div class="card card-primary">
      <div class="card-body">
        <ul class="nav nav-tabs nav-tabs-bottom" id="custom-tabs-three-tabbottom" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link" id="installment-details2" data-toggle="pill" href="#installment-details-id2" role="tab"
              aria-controls="installment-details-id" aria-selected="false">{{__('Installment & Retrocession')}}</a>
          </li>
        </ul>
      </div>
    </div>

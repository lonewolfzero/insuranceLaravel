...
<script type="text/javascript">
    ...
    $('#feshareto').change(function(){
        ...
        if(sumpct != '' && typetsi == '1'){
                ...
                var real_sum = conv_sum.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
                $('#sliptotalsumpct').val(convert(conv_sum));
                $('#sliptotalsumpct2').val(convert(conv_sum));
   ...
   $('#slipshare').keyup(function (e) 
       {
        if(e.keyCode != 9){
            ...
            $('#slipsumshare').val(convert(sumshare));
            $('#slipsumshare2').val(convert(sumshare));
        }
    });
...
<script type='text/javascript'>
    $('#addinsuredsave-btn').click(function(e){
       //alert('masuk');
        ...
        var flag_overseas = $('input[name="flag_overseas"]:checked').val();

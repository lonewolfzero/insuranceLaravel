                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="pasharefrom" name="pasharefrom" class="form-control form-control-sm amount" data-validation="length" readonly="readonly" data-validation-length="0-50" required/>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="input-group">
                                                        <input type="text" id="pashare" name="pashare" class="form-control form-control-sm amount" data-validation="length" readonly="readonly" data-validation-length="0-50" />
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="pashareto" name="pashareto" class="form-control form-control-sm amount" data-validation="length" data-validation-length="0-50" required/>
                                        </div>
                                    </div>
                                </div>
                            </div>

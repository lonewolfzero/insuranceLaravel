                                ...
                                <div class="card-body bg-light-gray">
                                    <div class="tab-content p-0 pt-1" id="custom-tabs-three-tabContent">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text"  id="sliprateupdate" name="sliprateupdate" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50" placeholder="a &permil;" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="" >{{__('Total Rate') }}</label>
                                                                <input type="hidden" id="sliptotalrateupdate" value="" name="sliptotalrateupdate" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50"   />
                                                                <input type="text" id="sliptotalrateupdate2" value="" name="sliptotalrateupdate2" class="form-control form-control-sm money text-left" data-validation="length" data-validation-length="0-50" disabled  />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="input-group">
                                                                            <input type="text" id="slipvbrokerupdate" name="slipvbrokerupdate"  class="form-control form-control-sm money text-left money text-left" data-validation="length" data-validation-length="0-50" placeholder="a" />
                                                                            <div class="input-group-append">
                                                                                <div class="input-group-text"><i class="fa fa-percent" aria-hidden="true"></i></div> 
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="input-group">
                                                                            <input type="hidden"  id="slipsumfeeupdate" name="slipsumfeeupdate"  class="form-control form-control-sm money text-left money text-left" data-validation="length" data-validation-length="0-50"  />
                                                                            <input type="text"  id="slipsumfeeupdate2" name="slipsumfeeupdate2"  class="form-control form-control-sm money text-left money text-left" data-validation="length" data-validation-length="0-50"  />
                                        ...
                                        <div class="tab-pane fade" id="installment-details-id4" role="tabpanel" aria-labelledby="installment-details">
                                                                    ...
                                                                    <div class="col-md-12 com-sm-12 mt-3">
                                                                        ...
                                                                        <tr>
                                                                           <td>
                                                                            ...
                                                                            <td>
                                                                                <div class="form-group">
                                                                                    <input type="hidden"  id="sliptotalpercentinspanupdate" name="sliptotalpercentinspanupdate">
                                                                                    <input type="hidden"  id="sliptotalamountinspanupdate" name="sliptotalamountinspanupdate">
                                            ...
                                            <input type="hidden" id="sliptotalpercentrporupdate" name="sliptotalpercentrporupdate" value="0">

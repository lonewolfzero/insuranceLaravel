...
<script type="text/javascript">
    ...
    $('#detailmodaldata').on('show.bs.modal', function(e) {
        ...
        $.ajax({
        url:'{{ url("/") }}/transaction-data/detailflslip/'+codesl,
        type:"GET",
        beforeSend: function() { $("body").addClass("loading");  },
        complete: function() {  $("body").removeClass("loading"); },
    ...
    $('#updatemodaldata').on('show.bs.modal', function(e) {
        ...
        $.ajax({
            ...
            success:function(response)
            {
                ...
                console.log('total ec ' + response.sum_ec)
                console.log('total sum percent ' + response.sum_ippercent)
...
<script type="text/javascript">
    ...
    $('#endorsementmodaldata').on('show.bs.modal', function(e) {
        ...
        $.ajax({
            url:'{{ url("/") }}/transaction-data/detailflendorsementslip/'+codesl,
            type:"GET",
            beforeSend: function() { $("body").addClass("loading");  },
            complete: function() {  $("body").removeClass("loading"); },
            success:function(response)
        ...
        if(choice == '1'){
            ...
            if(shareslipval != null){
                ...
                if(sliprate != null){
                    ...
                    if(grossprm_to_nr != null){
                        var nasionalreinsurance =  $('#flsharefromendorsement').val();
                        var totalnre =  $('#flsharetoendorsement').val();
                        var conv_totalnre =  parseInt(totalnre.replace(/,/g, ""));
    ...
    if(slipinterestid == null || ceding_id == null){
        ...
        if(sum_cedshare > int_tsiinsval){
            ...
            $.ajax({
                ...
                success:function(response){
                    console.log(response)
                    console.log("amount location " + response.amountlocation)
        ...
        e.preventDefault();
         ...
         $.ajaxSetup({
               ...
               $.ajax({
                 ...
                 success:function(response)
                 {
                    swal("Success!", "Financial Line Slip Update Status Cancelled", "success")
                    console.log(response)
                    ...
                    error: function (request, status, error) {
                        //alert(request.responseText);
                        swal("Error!", "Financial Line Slip Update Error", "Update Error");
                    }
                });
   ...
   $('#slipshareendorsement').change(function (e) {
        if(e.keyCode != 9){
            if($(this).val() < -100 || $(this).val() > 100){
                ...
                $('#slipsumorendorsement2').val(real_sumor);
                // $('#flshare').val(sumourshare.replace(/,/g, "."));
                $('#flsharefromendorsement').val(real_sumnre);
                            ...
                            if(tsislipval == new_instsi){
                                    ...
                                    $.ajax({
                                         ...
                                         data:{
                                           ...
                                           success:function(response)
                                           {
                                            swal("Success!", "Insured Financial Lines Slip Insert Success", "success")
                                            console.log(response)
                                        ...
                                        error: function (request, status, error) {
                                                //alert(request.responseText);
                                                swal("Error!", "Insured Financial Lines Slip Insert Error : " + request.responseText, "Insert Error");
                                            }
                                        });
                            ...
                            if(tsislipval == new_cedshareins){
                                    ...
                                    $.ajax({
                                         ...
                                         data:{
                                           ...
                                           success:function(response)
                                           {
                                            swal("Success!", "Insured Fnancial Lines Slip Insert Success", "success")
                                            console.log(response)
...
<script type='text/javascript'>
    $('#multi-file-upload-ajaxupdate').submit(function(e){
       ...
       var count_endorsement_ins = $('#flsliptotalpercentrpor').val();
       console.log('count endorsement ' + count_endorsement_ins)

       if (parseFloat(sliptotalpercentrpor) < 100.00) {
        swal("Error!", "Please input installment Retrocession until 100%", "warning");
       }
        if(parseFloat(current_percent) == 100.00)
        {
             $.ajaxSetup({
               ...
               $.ajax({
                 url:"{{url('transaction-data/fl-slip/updateform')}}",
                 type:"POST",
                 data:{
                     code_ms:code_ms,
                     slipnumber:slipnumber,
                 ...
                 success:function(response)
                 {
                    swal("Success!", "Insured Financial Lines Slip Update Success", "success")
                    console.log(response)
                    ...
                    error: function (request, status, error) {
                        //alert(request.responseText);
                        swal("Error!", "Insured Financial Lines Slip Update Error", "Update Error");
                    }
                });
...
<script type='text/javascript'>
    $('#multi-file-upload-ajaxendorsement').submit(function(e){
       ...
       $.ajax({
         ...
         success:function(response)
         {
            swal("Success!", "Insured Financial Lines Slip Endorsement Success", "success")
            console.log(response)
        ...
        error: function (request, status, error) {
            //alert(request.responseText);
            swal("Error!", "Insured Financial Lines Slip Endorsement Error", "Insert Error");
        }
...
<script type='text/javascript'>
    $('#multi-file-upload-ajax2').submit(function(e){
       ...
       $.ajax({
         ...
         data:{
           ...
           success:function(response)
           {
            swal("Success!", "Financial Line Slip Insert Success", "success")
            console.log(response)
    ...
    $.ajax({
      ...
      $.ajax({
        ...
        error: function (request, status, error) {
                //alert(request.responseText);
                swal("Error!", "Financial Line Insured Insert Error", "Insert Error");
            }
        });
       ...
       if(response){
        ...
        if(response.insured_data){
            ...
            for(var i = 0; i < insured_list.length; i++) 
            {
                ...
                $('#flsinsured').val(obj.insured_prefix);
            ...
            swal("Failed!", "Financial Line Insured Data Endorsement Failed", "Endorsement Failed")
        }
        ...
        if(response.location_data){
                ...
                if(response.risklocation_data)
                {
                    ...
                    for(var i = 0; i < risklocation_list.length; i++) 
                    {
                        ...
                        $('#tcid'+obj2.id+' > tbody:last-child').empty();
                                ...
                                swal("Failed!", "Financial Line Risk Location Data Endorsement Failed", "Endorsement Failed")
                            }
                        ...
                        swal("Failed!", "Financial Line Location Data Endorsement Failed", "Endorsement Failed")
                    }
                    ...
                    if(response.slip_data){
                        ...
                        swal("Failed!", "Financial Line Slip Data Endorsement Failed", "Endorsement Failed")

                    }
                    window.location.replace("{{url('transaction-data/fl-slipindex')}}");
                    swal("Success!", "Financial Line Slip Endorsement Success", "Endorsement Success")

                }else{
                    swal("Error!", "Financial Line Slip Endorsement Data Error", "Endorsement Data Error");
                }
            ...
            error: function (request, status, error) {
                //alert(request.responseText);
                swal("Error!", "Financial Line Slip Endorsement Error", "Endorsement Error");
            }
        });

                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="hiosharefrom" name="hiosharefrom" class="form-control form-control-sm amount" placeholder="total nasre share" data-validation="length" data-validation-length="0-50" readonly="readonly" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="input-group">
                                                        <input type="text" id="hioshare" name="hioshare" class="form-control form-control-sm amount" data-validation="length" data-validation-length="0-50" readonly="readonly" />
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="hioshareto" name="hioshareto" class="form-control form-control-sm amount" placeholder="total sum insured" data-validation="length" data-validation-length="0-50" />
                                        </div>
                                    </div>
                                </div>
                            </div>

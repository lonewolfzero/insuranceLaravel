...
class FinancialLineSlipController extends Controller
{
    ...
    public function indexflslip()
    {
        ...
        $userid = Auth::user()->id;
        $country = User::orderby('id', 'asc')->get();
        $route_active = 'Financial Line - Slip Entry';
        $mydate = date("Y") . date("m") . date("d");
        ...
        //$insured_now = Insured::whereDate('created_at', $currdate2)->where('slip_type', 'fl')->orderby('id', 'asc')->get();
        ...
        // $felookup = DB::table('fl_lookup_location')
        //             ->join('countries','countries.id','=','fl_lookup_location.country_id')
        //             ->select('fl_lookup_location.*','countries.code','countries.name')        
        //             ->orderby('id','asc')
        ...
        /*
        $check=Insured::where('number', '=', $code_ms)->first();
        $code_ms="";
        $i=2;
        ...
        if(!empty($check))
        {
            ...
            if ($lastid != null) {
                if ($lastid < 9) {
                    $code_ms = "IN" . $mydate . "0000" . strval($lastid + $i);
                } elseif ($lastid > 8 && $lastid < 99) {
                    $code_ms = "IN" . $mydate . "000" . strval($lastid + $i);
                } elseif ($lastid > 98 && $lastid < 999) {
                    $code_ms = "IN" . $mydate . "00" . strval($lastid + $i);
                } elseif ($lastid > 998 && $lastid < 9999) {
                    $code_ms = "IN" . $mydate . "0" . strval($lastid + $i);
                } elseif ($lastid > 9998 && $lastid < 99999) {
                    $code_ms = "IN" . $mydate  . strval($lastid + $i);
                }
            } else {
                $code_ms = "IN" . $mydate . "0000" . strval($i);
            }
        ...
        */
        ...
        $slipdatadistict = SlipTable::select('number')->distinct()->where('insured_id', $code_ms)->where('slipshow', 'yes')->where('slip_type', 'fl')->get();
       
        $slipdata2 = SlipTable::where('insured_id', $code_ms)->where('slipshow', 'yes')->where('slip_type', 'fl')->get();
        ...
        $maxdata = SlipTable::select('endorsment')->where('insured_id', $code_ms)->where('number', $code_sl)->where('slipshow', 'yes')->where('slip_type', 'fl')->orderby('endorsment','desc')->first();
        
        $checkinsurednumber = InsuredNumber::where('number', $code_ms)->where('slip_type', 'fl')->where('status', 'passive')->first();
        // $insurednumform = '';
        $checkslipnumber = SlipNumber::where('number', $code_sl)->where('insured_number', $code_ms)->where('slip_type', 'fl')->where('status', 'passive')->first();
        // $slipnumform = '';
        if ($checkinsurednumber != null) 
        {
            ...
            if ($checkslipnumber != null) 
            {
                ...
                $locationid = TransLocationTemp::select('id')->where('insured_id', '=', $code_ms)->where('slip_type','fl')->where('status','passive')->orderby('id', 'desc')->get();
                ...
                $installmentlist2 = InstallmentTemp::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'fl')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
                $extendcoveragelist2 = ExtendCoverageTemp::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'fl')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
                $deductiblelist2 = DeductibleTemp::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'fl')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
                $retrocessionlist2 = RetrocessionTemp::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'fl')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
                $locationlist3 = TransLocationTemp::where('insured_id', '=', $code_ms)->where('slip_type', '=', 'fl')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
                $attachmentlist2 = SlipTableFile::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'fl')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
                ...
                $installmentlist = InstallmentTemp::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'fl')->orderby('id', 'desc')->get();
                $extendcoveragelist = ExtendCoverageTemp::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'fl')->orderby('id', 'desc')->get();
                $deductiblelist = DeductibleTemp::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'fl')->orderby('id', 'desc')->get();
                $retrocessionlist = RetrocessionTemp::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'fl')->orderby('id', 'desc')->get();


                $locationlist2 = TransLocationTemp::where('insured_id', '=', $code_ms)->where('slip_type', 'fl')->orderby('id', 'desc')->get();
                ...
                $statuslist = StatusLog::where('insured_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'fl')->orderby('id', 'desc')->get();
              
                return view('crm.transaction.fl_slip', compact(['maxdata','slipdatadistict','brokerchoice','broker','prefixinsured', 'slipnumform', 'insurednumform', 'user', 'cnd', 'slipdata', 'slipdata2', 'statuslist', 'retrocessionlist', 'installmentlist', 'extendcoveragelist', 'deductiblelist', 'extendedcoverage', 'extendedcoverage', 'deductibletype', 'interestinsured', 'locationlist', 'felookup', 'currency', 'cob', 'koc', 'ocp', 'ceding', 'cedingbroker', 'route_active', 'currdate', 'slip', 'insured', 'fe_ids', 'code_ms', 'code_sl', 'costumer']));
            ...
            elseif ($checkslipnumber == null) 
            {
                ...
                $deductiblelist2 = DeductibleTemp::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'fl')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
                $retrocessionlist2 = RetrocessionTemp::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'fl')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
                $locationlist3 = TransLocationTemp::where('insured_id', '=', $code_ms)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'fl')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
                $attachmentlist2 = SlipTableFile::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'fl')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
        ...
        elseif ($checkinsurednumber == null) 
        {
            ...
            if ($checkslipnumber != null) {
                ...
                InsuredNumber::where('number', $code_ms)->where('slip_type', 'fl')->where('status', 'passive')->delete();
    ...
    public function getdetailSlip($idm)
    {
        ...
        $statustable = StatusLog::where('slip_id', $slipdata->number)->where('insured_id', $slipdata->insured_id)->where('count_endorsement', $slipdata->endorsment)->where('slip_type', 'fl')->orderby('created_at', 'DESC')->get();
        $statuslist = $statustable->unique('status');
        $statuslist->values()->all();


        $attachmenttable = collect(SlipTableFile::where('slip_id', '=', $slipdata->number)->where('insured_id', '=', $slipdata->insured_id)->where('slip_type', 'fl')->where('count_endorsement', $slipdata->endorsment)->orderby('id', 'DESC')->get());
    ...
    public function updateflslip($idm)
    {
        ...
        $slipdata = SlipTable::where('insured_id', $insureddata->number)->where('slipshow', 'yes')->where('selisih','false')->where('slip_type', 'fl')->first();
        // $slipdata2 = SlipTable::where('insured_id', $insureddata->number)->where('slipshow', 'yes')->where('slip_type', 'fl')->orderBy('endorsment','desc')->get();

       $slipdata2 = SlipTable::where('insured_id', $insureddata->number)->where('slipshow', 'yes')->where('selisih','false')->where('slip_type', 'fl')->join('ceding_broker', 'slip_table.source', '=', 'ceding_broker.id')->select('slip_table.*', 'ceding_broker.name')->orderBy('ceding_broker.name', 'asc')->orderBy('slip_table.endorsment', 'desc')->get();
        ...
        $dataslipdistict = collect(SlipTable::where('insured_id',$insureddata->number)->where('slipshow', 'yes')->where('selisih','false')->where('slip_type', 'fl')->get());
        ...
        if (!empty($slipdata)) {
            ...
            $slip = SlipTable::orderby('id', 'asc')->get();
            // $slip_now = SlipTable::whereDate('created_at',$currdate2)->where('slip_type','fl')->orderby('id','asc')->get();
            $slip_now = SlipTable::where('insured_id', $insureddata->number)->where('slip_type', 'fl')->where('slipshow', 'yes')->orderby('id', 'asc')->get();
            // dd($slip_now);
            $sliplastid = count($slip_now);
            // dd($sliplastid);
            $kondisi = false;
            ...
            $slip = SlipTable::orderby('id', 'asc')->get();
            // $slip_now = SlipTable::whereDate('created_at',$currdate)->where('slip_type','fl')->orderby('id','asc')->get();
            $slip_now = SlipTable::where('insured_id', $insureddata->number)->where('slip_type', 'fl')->where('slipshow', 'yes')->orderby('id', 'asc')->get();
            $sliplastid = count($slip_now);
       ...
       $maxdata = SlipTable::where('insured_id', $insureddata->number)->where('slip_type', 'fl')->where('selisih','false')->orderby('endorsment', 'desc')->first();
        // dd($maxdata);
        ...
        foreach($slip_now as $list_slip){
            ...
            InstallmentTemp::where('slip_id', '=', $list_slip->number)->where('insured_id', '=', $list_slip->insured_id)->where('slip_type', '=', 'fl')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
            ExtendCoverageTemp::where('slip_id', '=',  $list_slip->number)->where('insured_id', '=', $list_slip->insured_id)->where('slip_type', '=', 'fl')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
            DeductibleTemp::where('slip_id', '=',  $list_slip->number)->where('insured_id', '=', $list_slip->insured_id)->where('slip_type', '=', 'fl')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
            RetrocessionTemp::where('slip_id', '=',  $list_slip->number)->where('insured_id', '=', $list_slip->insured_id)->where('slip_type', '=', 'fl')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
            TransLocationTemp::where('insured_id', '=', $list_slip->insured_id)->where('slip_type', '=', 'fl')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
            SlipTableFile::where('slip_id', '=',  $list_slip->number)->where('insured_id', '=', $list_slip->insured_id)->where('slip_type', '=', 'fl')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
            
            $locationidcurr = TransLocationTemp::select('id')->where('insured_id', '=', $list_slip->insured_id)->where('slip_type','fl')->where('status','passive')->orderby('id', 'desc')->get();
            foreach ($locationidcurr as $dataid) {
                RiskLocationDetail::where('translocation_id', '=', $dataid->id)->where('slip_type','fl')->where('status','passive')->delete();
            }
        ...
        $locationlist3 = TransLocationTemp::where('insured_id', '=', $code_ms)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'fl')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
        $attachmentlist2 = SlipTableFile::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'fl')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
        // $filelist = SlipTableFile::where('slip_id','=',$code_sl)->where('insured_id','=',$code_ms)->where('slip_type','=','fl')->where('status','=','passive')->orderby('id','desc')->delete();
        ...
        $deductiblelist = DeductibleTemp::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'fl')->orderby('id', 'desc')->get();
        $retrocessionlist = RetrocessionTemp::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'fl')->orderby('id', 'desc')->get();
        $filelist = SlipTableFile::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'fl')->where('status', '=', 'passive')->orderby('id', 'desc')->get();
        ...
        return view('crm.transaction.fl_slipupdate', compact(['maxdata','slipdatadistict','sumperceding','brokerchoice','broker','prefixinsured', 'slipnumform', 'user', 'userid', 'cnd', 'slipdata2', 'filelist', 'slipdata', 'insureddata', 'statuslist', 'retrocessionlist', 'installmentlist', 'extendcoveragelist', 'deductiblelist', 'extendedcoverage', 'extendedcoverage', 'deductibletype', 'interestinsured', 'locationlist', 'interestlist', 'felookup', 'currency', 'cob', 'koc', 'ocp', 'ceding', 'cedingbroker', 'route_active', 'currdate', 'slip', 'insured', 'fe_ids', 'code_ms', 'code_sl', 'costumer']));
    }


    
    public function updateflslipmodal(Request $request)
    {
        ...
        if ($validator) {
            ...
            $slipdata = SlipTable::where('number', '=', $request->slipnumber)->where('insured_id',$request->code_ms)->where('slip_type','fl')->where('endorsment',$request->countendorsement)->first();

            $interestlist = InterestInsuredTemp::where('insured_id', '=', $request->code_ms)->orderby('id', 'desc')->get();
            $installmentlist = InstallmentTemp::where('slip_id', '=', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'fl')->where('count_endorsement',$request->countendorsement)->where('minus','false')->where('deleted_at', null)->orderby('id', 'desc')->get();
            $extendcoveragelist = ExtendCoverageTemp::where('slip_id', '=', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'fl')->where('count_endorsement',$request->countendorsement)->where('minus','false')->where('deleted_at', null)->orderby('id', 'desc')->get();
            $deductiblelist = DeductibleTemp::where('slip_id', '=', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'fl')->where('count_endorsement',$request->countendorsement)->where('minus','false')->where('deleted_at', null)->orderby('id', 'desc')->get();
            $retrocessionlist = RetrocessionTemp::where('slip_id', '=', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'fl')->where('count_endorsement',$request->countendorsement)->where('minus','false')->where('deleted_at', null)->orderby('id', 'desc')->get();
            ...
            $deductibleup = DeductibleTemp::where('slip_id', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', 'fl')->where('status', 'passive')->orderby('id', 'desc')->get();
            ...
            $extendcoverageup = ExtendCoverageTemp::where('slip_id', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', 'fl')->where('status', 'passive')->orderby('id', 'desc')->get();
            ...
            $installmentpansup = InstallmentTemp::where('slip_id', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', 'fl')->where('status', 'passive')->orderby('id', 'desc')->get();
            ...
            $retrocessionpanup = RetrocessionTemp::where('slip_id', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', 'fl')->where('status', 'passive')->orderby('id', 'desc')->get();
    ...
    public function endorsementflslip($ms, $sl)
    {
        ...
        return view('crm.transaction.fl_slipendorsement', compact(['user', 'cnd', 'slipdata2', 'countendorsement', 'filelist', 'slipdata', 'insureddata', 'statuslist', 'retrocessionlist', 'installmentlist', 'extendcoveragelist', 'deductiblelist', 'extendedcoverage', 'extendedcoverage', 'deductibletype', 'interestinsured', 'locationlist', 'interestlist', 'felookup', 'currency', 'cob', 'koc', 'ocp', 'ceding', 'cedingbroker', 'route_active', 'currdate', 'slip', 'insured', 'fe_ids', 'code_ms', 'code_sl', 'costumer']));
    }
    ...
    public function storeflinsured(Request $request)
    {
        ...
        $costumcheck = Customer::where('company_name', '=', $request->flsuggestinsured)->first();
        if ($costumcheck == null) {

            Customer::create([
                'owner_id' => '1',
                'industry_id' => '27',
                'company_prefix' => $request->flinsured,
                'company_name' => $request->flsuggestinsured,
                'website' => $request->flsuggestinsured,
                'company_suffix' => $request->flsuffix
            ]);
        }
        ...
        if ($validator) 
        {
            ...
            $locationlist = TransLocationTemp::where('insured_id', '=', $request->flnumber)->where('slip_type', 'fl')->orderby('id', 'desc')->get();
            ...
            $checkinsurednumber = InsuredNumber::where('number', $request->flnumber)->where('slip_type', 'fl')->where('status', 'active')->first();

            // $checkslipnumber= SlipNumber::where('number',$code_sl)->where('insured_number',$code_ms)->where('slip_type','fl')->where('status','passive')->first();
            if($checkinsurednumber == null) 
            {
                $insureddata = Insured::where('number', '=', $request->flnumber)->where('slip_type','fl')->first();
                if($insureddata == null) 
                {
                    $insureddataup = Insured::create([
                        'number' => $request->flnumber,
                        'slip_type' => 'fl',
                        'prefix_id' => $request->flinsured,
                    ...
                    $insurednumberdata = InsuredNumber::where('number', $request->flnumber)->orderby('id', 'desc')->first();
                    $insurednumberdata->status = 'active';
                    $insurednumberdata->save();

                    $TransLocationup = TransLocationTemp::where('insured_id', '=', $request->flnumber)->where('slip_type', 'fl')->where('status', 'passive')->orderby('id', 'desc')->get();
                    ...
                    $notification = array(
                        'message' => 'Financial LineInsured added successfully!',
                        'alert-type' => 'success',
                ...
                else 
                {
                    ...
                    if($insureddata->share_to != $request->flshareto)
                    {
                        $insureddataid = $insureddata->id;
                        $insureddataup = Insured::findOrFail($insureddataid);

                        $insureddataup->prefix_id = $request->flinsured;
                        ...
                        $SlipTableUp = SlipTable::where('insured_id', '=', $insureddataup->number)->where('slip_type', 'fl')->where('slipshow', 'yes')->orderby('id', 'desc')->get();
                        ...
                        $notification = array(
                            'message' => 'Financial LineInsured Update successfully!, but tsi changed. Must Change!!!',
                            'alert-type' => 'success',
                            'count_endorsement' => $insureddataup->count_endorsement,
                            'ceding_share' => $sum_amount
                        );
                    ...
                    else
                    {
                        ...
                        $notification = array(
                            'message' => 'Financial LineInsured Update successfully!',
                            'alert-type' => 'success',
                            'count_endorsement' => $insureddataup->count_endorsement,
                            'ceding_share' => $sum_amount
                        );
            ...
            {
                $newnumber2 = substr($request->flnumber, 10, 15);
                $codenumber = substr($request->flnumber, 0, 10);
                ...
                if ($insureddata == null) 
                {
                    ...
                    $TransLocationup = TransLocationTemp::where('insured_id', '=', $code_ms2)->where('slip_type', 'fl')->where('status', 'passive')->orderby('id', 'desc')->get();
                    foreach ($TransLocationup as $tstup) {
                        $translocationprocessup = TransLocationTemp::findOrFail($tstup->id);
                        $translocationprocessup->status = 'active';
                        $translocationprocessup->save();
            ...
            return response($notification);
            //Session::flash('Success', 'Financial LineInsured added successfully', 'success');
            //return redirect()->route('liniusaha.index');

        } else {

            $notification = array(
                'message' => 'Financial LineInsured added Failed!',
                'alert-type' => 'success'
            );

            return back()->with($validator)->withInput();
            //Session::flash('Failed', 'Financial LineInsured Failed added', 'danger');
            //return redirect()->route('liniusaha.index');
        }
    }
    ...
    public function storeflslip(Request $request)
    {
        ...
        if ($validator) {
            ...
            $checkslipnumber = SlipNumber::where('number', $request->slipnumber)->where('insured_number', $request->code_ms)->where('slip_type', 'fl')->where('status', 'active')->first();
            ...
            if ($checkslipnumber == null) {
                ...
                // $interestlist = InterestInsuredTemp::where('insured_id', '=', $request->code_ms)->orderby('id', 'desc')->get();
                // $installmentlist = InstallmentTemp::where('slip_id', '=', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'fl')->where('deleted_at', null)->orderby('id', 'desc')->get();
                // $extendcoveragelist = ExtendCoverageTemp::where('slip_id', '=', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'fl')->where('deleted_at', null)->orderby('id', 'desc')->get();
                // $deductiblelist = DeductibleTemp::where('slip_id', '=', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'fl')->where('deleted_at', null)->orderby('id', 'desc')->get();
                // $retrocessionlist = RetrocessionTemp::where('slip_id', '=', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'fl')->where('deleted_at', null)->orderby('id', 'desc')->get();

                $interestlist = InterestInsuredTemp::where('insured_id', '=', $request->code_ms)->orderby('id', 'desc')->get();
                $installmentlist = InstallmentTemp::where('slip_id', '=', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'fl')->where('minus','false')->where('count_endorsement',0)->where('deleted_at', null)->orderby('id', 'desc')->get();
                $extendcoveragelist = ExtendCoverageTemp::where('slip_id', '=', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'fl')->where('minus','false')->where('count_endorsement',0)->where('deleted_at', null)->orderby('id', 'desc')->get();
                $deductiblelist = DeductibleTemp::where('slip_id', '=', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'fl')->where('minus','false')->where('count_endorsement',0)->where('deleted_at', null)->orderby('id', 'desc')->get();
                $retrocessionlist = RetrocessionTemp::where('slip_id', '=', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'fl')->where('minus','false')->where('count_endorsement',0)->where('deleted_at', null)->orderby('id', 'desc')->get();
                ...
                if ($slipdata == null) {
                    ...
                    $slipnumberdata = SlipNumber::where('number', $request->slipnumber)->where('slip_type', 'fl')->orderby('id', 'desc')->first();
                    ...
                    $currdate2 = date("Y-m-d");
                    $mydate = date("Y") . date("m") . date("d");
                    $slip_now = SlipTable::whereDate('created_at', $currdate2)->where('slip_type', 'fl')->where('insured_id', $request->code_ms)->orderby('id', 'asc')->get();
                    $sliplastid = count($slip_now);
                    // dd($sliplastid);
                ...
                $interestlist = InterestInsuredTemp::where('insured_id', '=', $request->code_ms)->orderby('id', 'desc')->get();
                $installmentlist = InstallmentTemp::where('slip_id', '=', $code_sl2)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'fl')->orderby('id', 'desc')->get();
                $extendcoveragelist = ExtendCoverageTemp::where('slip_id', '=', $code_sl2)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'fl')->orderby('id', 'desc')->get();
                $deductiblelist = DeductibleTemp::where('slip_id', '=', $code_sl2)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'fl')->orderby('id', 'desc')->get();
                $retrocessionlist = RetrocessionTemp::where('slip_id', '=', $code_sl2)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'fl')->orderby('id', 'desc')->get();
                ...
                if ($slipdata == null) {
                    ...
                    $slipnumberdata = SlipNumber::where('number', $code_sl2)->where('slip_type', 'fl')->orderby('id', 'desc')->first();
                    $slipnumberdata->status = 'active';
                    $slipnumberdata->save();
                    ...
                    $deductibleup = DeductibleTemp::where('slip_id', $code_sl2)->where('insured_id', '=', $request->code_ms)->where('slip_type', 'fl')->where('status', 'passive')->orderby('id', 'desc')->get();
                    foreach ($deductibleup as $ddup) {
                        $deductibleprocessup = DeductibleTemp::findOrFail($ddup->id);
                        $deductibleprocessup->status = 'active';
                        $deductibleprocessup->save();
                    ...
                    $extendcoverageup = ExtendCoverageTemp::where('slip_id', $code_sl2)->where('insured_id', '=', $request->code_ms)->where('slip_type', 'fl')->where('status', 'passive')->orderby('id', 'desc')->get();
                    foreach ($extendcoverageup as $ecup) {
                        $extendcoverageprocessup = ExtendCoverageTemp::findOrFail($ecup->id);
                        $extendcoverageprocessup->status = 'active';
                        $extendcoverageprocessup->save();
                    ...
                    $installmentpansup = InstallmentTemp::where('slip_id', $code_sl2)->where('insured_id', '=', $request->code_ms)->where('slip_type', 'fl')->where('status', 'passive')->orderby('id', 'desc')->get();
                    foreach ($installmentpansup as $ipup) {
                        $inspanprocessup = InstallmentTemp::findOrFail($ipup->id);
                        $inspanprocessup->status = 'active';
                        $inspanprocessup->save();
                    ...
                    $retrocessionpanup = RetrocessionTemp::where('slip_id', $code_sl2)->where('insured_id', '=', $request->code_ms)->where('slip_type', 'fl')->where('status', 'passive')->orderby('id', 'desc')->get();
                    foreach ($retrocessionpanup as $rpup) {
                        $retropanprocessup = RetrocessionTemp::findOrFail($rpup->id);
                        $retropanprocessup->status = 'active';
                        $retropanprocessup->save();
    ...
    public function storeendorsementflslip(Request $request)
    {
        $validator = $request->validate([
            'slipid' => 'required'
        ]);
        ...
        if ($validator) {
            ...
            // $slipdatalist= SlipTable::where('insured_id','=',$slipdata->insured_id)->where('slip_type','fl')->where('selisih','=','false')->get();
            $slipdatalist = SlipTable::where('id', '=', $request->slipid)->where('insured_id', '=', $slipdata->insured_id)->where('endorsment',$slipdata->endorsment)->where('slip_type', 'fl')->orderby('id', 'desc')->first();
            $insureddata = Insured::where('number', '=', $slipdata->insured_id)->where('slip_type', '=', 'fl')->where('count_endorsement', $slipdata->endorsment)->first();
            ...
            $installmentlist = InstallmentTemp::where('slip_id', '=', $slipdata->number)->where('insured_id', '=', $slipdata->insured_id)->where('slip_type', '=', 'fl')->where('minus','false')->where('count_endorsement',$request->countendorsement)->where('deleted_at', null)->orderby('id', 'desc')->get();
            $extendcoveragelist = ExtendCoverageTemp::where('slip_id', '=', $slipdata->number)->where('insured_id', '=', $slipdata->insured_id)->where('slip_type', '=', 'fl')->where('minus','false')->where('count_endorsement',$request->countendorsement)->where('deleted_at', null)->orderby('id', 'desc')->get();
            $deductiblelist = DeductibleTemp::where('slip_id', '=', $slipdata->number)->where('insured_id', '=', $slipdata->insured_id)->where('slip_type', '=', 'fl')->where('minus','false')->where('count_endorsement',$request->countendorsement)->where('deleted_at', null)->orderby('id', 'desc')->get();
            $retrocessionlist = RetrocessionTemp::where('slip_id', '=', $slipdata->number)->where('insured_id', '=', $slipdata->insured_id)->where('slip_type', '=', 'fl')->where('minus','false')->where('count_endorsement',$request->countendorsement)->where('deleted_at', null)->orderby('id', 'desc')->get();
            $locationlist = TransLocationTemp::where('insured_id', '=', $slipdata->insured_id)->where('slip_type', '=', 'fl')->orderby('id', 'desc')->get();
            $attachmentlist = SlipTableFile::where('slip_id', '=', $slipdata->number)->where('insured_id', '=', $slipdata->insured_id)->where('slip_type', '=', 'fl')->orderby('id', 'desc')->get();
                ...
                if ($slipdatalast == null) {
                    ...
                    if ($deductiblelist != null) {
                        foreach ($deductiblelist as $dt) {
                            ...
                            // $jsondtlistup = DeductibleTemp::where('slip_id', '=', $dtlistup->slip_id)->where('insured_id', '=', $dtlistup->insured_id)->where('slip_type','fl')->where('minus','false')->where('count_endorsement', $dtlistup->count_endorsement)->where('deleted_at', null)->orderby('id', 'desc')->get();
                            ...
                            $jsondtlistupminus = DeductibleTemp::where('slip_id', '=', $dtdata->slip_id)->where('insured_id', '=', $dtdata->insured_id)->where('slip_type','fl')->where('minus','true')->where('count_endorsement', $dtlistupminus->count_endorsement)->where('deleted_at', null)->orderby('id', 'desc')->get();
                    ...
                    if ($extendcoveragelist != null) {
                        foreach ($extendcoveragelist as $ect) {
                            ...
                            // $jsonectlistup = ExtendCoverageTemp::where('slip_id', '=', $ectlistup->slip_id)->where('insured_id', '=', $ectlistup->insured_id)->where('slip_type','fl')->where('minus','false')->where('count_endorsement', $ectlistup->count_endorsement)->where('deleted_at', null)->orderby('id', 'desc')->get();

                            $datajsonectlistup = collect(ExtendCoverageTemp::where('slip_id', '=', $ectlistup->slip_id)
                                                ->where('insured_id', '=', $ectlistup->insured_id)
                                                ->where('slip_type','fl')->where('minus','false')
                            ...
                            $jsonectlistupminus = ExtendCoverageTemp::where('slip_id', '=', $ectdata->slip_id)->where('insured_id', '=', $ectdata->insured_id)->where('slip_type','fl')->where('minus','true')->where('count_endorsement', $ectdata->count_endorsement)->where('deleted_at', null)->orderby('id', 'desc')->get();
                    ...
                    if ($installmentlist != null) {
                        foreach ($installmentlist as $ipt) {
                            ...
                            // $jsoniptlistup = InstallmentTemp::where('slip_id', '=', $iptlistup->slip_id)->where('insured_id', '=', $iptlistup->insured_id)->where('slip_type','fl')->where('minus','false')->where('count_endorsement', $iptlistup->count_endorsement)->where('deleted_at', null)->orderby('id', 'desc')->get();
                            ...
                            $jsoniptlistupminus = InstallmentTemp::where('slip_id', '=', $iptdata->slip_id)->where('insured_id', '=', $iptdata->insured_id)->where('slip_type','fl')->where('minus','true')->where('count_endorsement', $iptdata->count_endorsement)->where('deleted_at', null)->orderby('id', 'desc')->get();
                    ...
                    if (!$retrocessionlist) {
                        ...
                        foreach ($retrocessionlist as $rct) {
                            ...
                            $jsonrctlistup = RetrocessionTemp::where('slip_id', '=', $rctlistup->slip_id)->where('insured_id', '=', $rctlistup->insured_id)->where('slip_type','fl')->where('minus','false')->where('count_endorsement', $rctlistup->count_endorsement)->where('deleted_at', null)->orderby('id', 'desc')->get();
                            ...
                            $jsonrctlistupminus = RetrocessionTemp::where('slip_id', '=', $rctdata->slip_id)->where('insured_id', '=', $rctdata->insured_id)->where('slip_type','fl')->where('minus','true')->where('count_endorsement', $rctdata->count_endorsement)->where('deleted_at', null)->orderby('id', 'desc')->get();
                    ...
                    $attachmentcheck = SlipTableFile::where('slip_id', $slipdata->number)->where('insured_id', $slipdata->insured_id)->where('count_endorsement', $slipdata->endorsment)->where('slip_type', 'fl')->get();
                    ...
                    $statuslogcheck = StatusLog::where('slip_id', $slipdata->number)->where('insured_id', $slipdata->insured_id)->where('count_endorsement', $slipdata->endorsment)->where('slip_type', 'fl')->get();
                    ...
                    $slipdatalist2 = SlipTable::where('insured_id', '=', $slipdata->insured_id)->where('slip_type', '=', 'fl')->get();
                    ...
                    $slipdata2 = DB::table('slip_table as stb')
                                ...
                                ->get();
                    // $slipdatadistict = SlipTable::select('number')->where('insured_id', $slipdataup->insured_id)->where('slipshow', 'yes')->where('slip_type', 'fl')->join('ceding_broker', 'slip_table.source', '=', 'ceding_broker.id')->select('slip_table.*', 'ceding_broker.name')->orderBy('ceding_broker.name', 'asc')->orderBy('slip_table.endorsment', 'desc')->distinct()->get('slip_table.number');
                    ...
                    $maxdata = SlipTable::where('insured_id', $slipdataup->insured_id)->where('slip_type', 'fl')->orderby('endorsment', 'desc')->first();
    ...
    public function updateendorsement(Request $request)
    {
        ...
        $notification = array(
            'message' => 'Financial Line Slip Update Endorsement successfully!',
            'alert-type' => 'success'
        );
    ...
    public function changeDecline($id)
    {
        ...
        $notification = array(
            'message' => 'Financial Line Insured  & Slip Status Decline successfully!',
            'alert-type' => 'success'
        );
        return back()->with($notification);
    }
    ...
    public function changeCancel($id)
    {
        ...
        $notification = array(
            'message' => 'Financial Line Insured & Slip Status Cancel successfully!',
            'alert-type' => 'success'
        );
        return back()->with($notification);
    }

...
class PortofolioController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        if (!empty($treatyyeardata) || !empty($prodyeardata)  || !empty($ceding_brokerdata)  || !empty($ceding_companydata) || !empty($cob_inputdata) || !empty($koc_inputdata)) 
        {
    ...
    public function entry(Request $request)
    {
        if(!empty($request->id)) 
        {
            $accu = Accumulation::where('id',$request->id)->first();
        }
        ...
        $props = Prop::orderBy("counter_number", "desc")
        ->get()
        ->groupBy('id_detail_contract');
    ...
    public function portofolioentry()
    {

...
class HeMotorSlipController extends Controller
{
    ...
    public function getdetailSlip($idm)
    {
        ...
        $statustable = StatusLog::where('slip_id', $slipdata->number)->where('insured_id', $slipdata->insured_id)->where('count_endorsement', $slipdata->endorsment)->where('slip_type', 'hem')->orderby('created_at', 'DESC')->get();
        $statuslist = $statustable->unique('status');
        $statuslist->values()->all();


        $attachmenttable = collect(SlipTableFile::where('slip_id', '=', $slipdata->number)->where('insured_id', '=', $slipdata->insured_id)->where('slip_type', 'hem')->where('count_endorsement', $slipdata->endorsment)->orderby('id', 'DESC')->get());
    ...
    public function indexhemslip()
    {
        ...
        //$insured_now = Insured::whereDate('created_at', $currdate2)->where('slip_type', 'hem')->orderby('id', 'asc')->get();
        ...
        $slipdatadistict = SlipTable::select('number')->distinct()->where('insured_id', $code_ms)->where('slipshow', 'yes')->where('slip_type', 'hem')->get();
       
        $slipdata2 = SlipTable::where('insured_id', $code_ms)->where('slipshow', 'yes')->where('slip_type', 'hem')->get();
        ...
        $maxdata = SlipTable::select('endorsment')->where('insured_id', $code_ms)->where('number', $code_sl)->where('slipshow', 'yes')->where('slip_type', 'hem')->orderby('endorsment','desc')->first();
        
        $checkinsurednumber = InsuredNumber::where('number', $code_ms)->where('slip_type', 'hem')->where('status', 'passive')->first();
        // $insurednumform = '';
        $checkslipnumber = SlipNumber::where('number', $code_sl)->where('insured_number', $code_ms)->where('slip_type', 'hem')->where('status', 'passive')->first();
        // $slipnumform = '';
        if ($checkinsurednumber != null) {
            ...
            if ($checkslipnumber != null) {
                ...
                $locationid = TransLocationTemp::select('id')->where('insured_id', '=', $code_ms)->where('slip_type','hem')->where('status','passive')->orderby('id', 'desc')->get();
                ...
                $installmentlist2 = InstallmentTemp::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'hem')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
                $extendcoveragelist2 = ExtendCoverageTemp::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'hem')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
                $deductiblelist2 = DeductibleTemp::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'hem')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
                $retrocessionlist2 = RetrocessionTemp::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'hem')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
                $locationlist3 = TransLocationTemp::where('insured_id', '=', $code_ms)->where('slip_type', '=', 'hem')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
                $attachmentlist2 = SlipTableFile::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'hem')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
                ...
                $installmentlist = InstallmentTemp::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'hem')->orderby('id', 'desc')->get();
                $extendcoveragelist = ExtendCoverageTemp::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'hem')->orderby('id', 'desc')->get();
                $deductiblelist = DeductibleTemp::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'hem')->orderby('id', 'desc')->get();
                $retrocessionlist = RetrocessionTemp::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'hem')->orderby('id', 'desc')->get();


                $locationlist2 = TransLocationTemp::where('insured_id', '=', $code_ms)->where('slip_type', 'hem')->orderby('id', 'desc')->get();
                ...
                $statuslist = StatusLog::where('insured_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'hem')->orderby('id', 'desc')->get();

                return view('crm.transaction.hem_slip', compact(['maxdata','slipdatadistict','brokerchoice','broker','prefixinsured', 'slipnumform', 'insurednumform', 'user', 'cnd', 'slipdata', 'slipdata2', 'statuslist', 'retrocessionlist', 'installmentlist', 'extendcoveragelist', 'deductiblelist', 'extendedcoverage', 'extendedcoverage', 'deductibletype', 'interestinsured', 'locationlist', 'felookup', 'currency', 'cob', 'koc', 'ocp', 'ceding', 'cedingbroker', 'route_active', 'currdate', 'slip', 'insured', 'fe_ids', 'code_ms', 'code_sl', 'costumer']));
            } 
            elseif ($checkslipnumber == null) 
            {
                ...
                $deductiblelist2 = DeductibleTemp::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'hem')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
                $retrocessionlist2 = RetrocessionTemp::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'hem')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
                $locationlist3 = TransLocationTemp::where('insured_id', '=', $code_ms)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'hem')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
                $attachmentlist2 = SlipTableFile::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'hem')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
            ...
            if ($checkslipnumber != null) {
                ...
                InsuredNumber::where('number', $code_ms)->where('slip_type', 'hem')->where('status', 'passive')->delete();
    ...
    public function updatehemslip($idm)
    {
        ...
        $brokerchoice = DB::table('risk_location_detail')
            ->join('ceding_broker', 'ceding_broker.id', '=', 'risk_location_detail.ceding_id')
            ->join('trans_location_detail', 'trans_location_detail.id', '=', 'risk_location_detail.translocation_id')
            ->where('trans_location_detail.slip_type', '=', 'hem')
        ...
        $slipdata = SlipTable::where('insured_id', $insureddata->number)->where('slipshow', 'yes')->where('selisih','false')->where('slip_type', 'hem')->first();
        // $slipdata2 = SlipTable::where('insured_id', $insureddata->number)->where('slipshow', 'yes')->where('slip_type', 'hem')->orderBy('endorsment','desc')->get();

        $slipdata2 = SlipTable::where('insured_id', $insureddata->number)->where('slipshow', 'yes')->where('selisih','false')->where('slip_type', 'hem')->join('ceding_broker', 'slip_table.source', '=', 'ceding_broker.id')->select('slip_table.*', 'ceding_broker.name')->orderBy('ceding_broker.name', 'asc')->orderBy('slip_table.endorsment', 'desc')->get();
        // $slipdatadistict = DB::table('slip_table')->select('slip_table.*')->where('slip_table.insured_id', $insureddata->number)->where('slip_table.selisih', 'false')->where('slip_table.slipshow', 'yes')->where('slip_table.slip_type', 'hem')->distinct('slip_table.number')->get();
        //$slipdatadistict = SlipTable::select('number')->distinct()->where('insured_id', $code_ms)->where('slipshow', 'yes')->where('slip_type', 'hem')->get();
        
        $dataslipdistict = collect(SlipTable::where('insured_id',$insureddata->number)->where('slipshow', 'yes')->where('selisih','false')->where('slip_type', 'hem')->get());
        ...
        if (!empty($slipdata)) {
            ...
            $slip = SlipTable::orderby('id', 'asc')->get();
            // $slip_now = SlipTable::whereDate('created_at',$currdate2)->where('slip_type','hem')->orderby('id','asc')->get();
            $slip_now = SlipTable::where('insured_id', $insureddata->number)->where('slip_type', 'hem')->where('slipshow', 'yes')->orderby('id', 'asc')->get();
            // dd($slip_now);
            $sliplastid = count($slip_now);
            // dd($sliplastid);
            $kondisi = false;
            ...
            $slip = SlipTable::orderby('id', 'asc')->get();
            // $slip_now = SlipTable::whereDate('created_at',$currdate)->where('slip_type','hem')->orderby('id','asc')->get();
            $slip_now = SlipTable::where('insured_id', $insureddata->number)->where('slip_type', 'hem')->where('slipshow', 'yes')->orderby('id', 'asc')->get();
            $sliplastid = count($slip_now);
        ...
        $maxdata = SlipTable::where('insured_id', $insureddata->number)->where('slip_type', 'hem')->where('selisih','false')->orderby('endorsment', 'desc')->first();
        // dd($maxdata);
        ...
        foreach($slip_now as $list_slip){
            ...
            InstallmentTemp::where('slip_id', '=', $list_slip->number)->where('insured_id', '=', $list_slip->insured_id)->where('slip_type', '=', 'hem')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
            ExtendCoverageTemp::where('slip_id', '=',  $list_slip->number)->where('insured_id', '=', $list_slip->insured_id)->where('slip_type', '=', 'hem')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
            DeductibleTemp::where('slip_id', '=',  $list_slip->number)->where('insured_id', '=', $list_slip->insured_id)->where('slip_type', '=', 'hem')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
            RetrocessionTemp::where('slip_id', '=',  $list_slip->number)->where('insured_id', '=', $list_slip->insured_id)->where('slip_type', '=', 'hem')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
            TransLocationTemp::where('insured_id', '=', $list_slip->insured_id)->where('slip_type', '=', 'hem')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
            SlipTableFile::where('slip_id', '=',  $list_slip->number)->where('insured_id', '=', $list_slip->insured_id)->where('slip_type', '=', 'hem')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
            
            $locationidcurr = TransLocationTemp::select('id')->where('insured_id', '=', $list_slip->insured_id)->where('slip_type','hem')->where('status','passive')->orderby('id', 'desc')->get();
            foreach ($locationidcurr as $dataid) {
                RiskLocationDetail::where('translocation_id', '=', $dataid->id)->where('slip_type','hem')->where('status','passive')->delete();
            }
        ...
        $locationlist3 = TransLocationTemp::where('insured_id', '=', $code_ms)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'hem')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
        $attachmentlist2 = SlipTableFile::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'hem')->where('status', '=', 'passive')->orderby('id', 'desc')->delete();
        // $filelist = SlipTableFile::where('slip_id','=',$code_sl)->where('insured_id','=',$code_ms)->where('slip_type','=','hem')->where('status','=','passive')->orderby('id','desc')->delete();
        ...
        $deductiblelist = DeductibleTemp::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'hem')->orderby('id', 'desc')->get();
        $retrocessionlist = RetrocessionTemp::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'hem')->orderby('id', 'desc')->get();
        $filelist = SlipTableFile::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'hem')->where('status', '=', 'active')->orderby('id', 'desc')->get();
        ...
        return view('crm.transaction.hem_slipupdate', compact(['maxdata', 'slipdatadistict', 'sumperceding', 'brokerchoice', 'broker', 'prefixinsured', 'slipnumform', 'user', 'userid', 'cnd', 'slipdata2', 'filelist', 'slipdata', 'insureddata', 'statuslist', 'retrocessionlist', 'installmentlist', 'extendcoveragelist', 'deductiblelist', 'extendedcoverage', 'extendedcoverage', 'deductibletype', 'interestinsured', 'locationlist', 'interestlist', 'felookup', 'currency', 'cob', 'koc', 'ocp', 'ceding', 'cedingbroker', 'route_active', 'currdate', 'slip', 'insured', 'fe_ids', 'code_ms', 'code_sl', 'costumer']));
    }
    ...
    //     $maxdata = SlipTable::where('insured_id', $insureddata->number)->where('slip_type', 'fe')->where('selisih','false')->orderby('endorsment', 'desc')->first();
    //     // dd($maxdata);
    ...
    //     $deductiblelist = DeductibleTemp::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'hem')->orderby('id', 'desc')->get();
    //     $retrocessionlist = RetrocessionTemp::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'hem')->orderby('id', 'desc')->get();
    //     $filelist = SlipTableFile::where('slip_id', '=', $code_sl)->where('insured_id', '=', $code_ms)->where('slip_type', '=', 'hem')->where('status', '=', 'passive')->orderby('id', 'desc')->get();
    ...
    public function updatehemslipmodal(Request $request)
    {
        ...
        if ($validator) {
            ...
            $slipdata = SlipTable::where('number', '=', $request->slipnumber)->where('insured_id',$request->code_ms)->where('slip_type','hem')->where('endorsment',$request->countendorsement)->first();

            $interestlist = InterestInsuredTemp::where('insured_id', '=', $request->code_ms)->orderby('id', 'desc')->get();
            $installmentlist = InstallmentTemp::where('slip_id', '=', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'hem')->where('count_endorsement',$request->countendorsement)->where('minus','false')->where('deleted_at', null)->get();
            $extendcoveragelist = ExtendCoverageTemp::where('slip_id', '=', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'hem')->where('count_endorsement',$request->countendorsement)->where('minus','false')->where('deleted_at', null)->get();
            $deductiblelist = DeductibleTemp::where('slip_id', '=', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'hem')->where('count_endorsement',$request->countendorsement)->where('minus','false')->where('deleted_at', null)->get();
            $retrocessionlist = RetrocessionTemp::where('slip_id', '=', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'hem')->where('count_endorsement',$request->countendorsement)->where('minus','false')->where('deleted_at', null)->get();
            ...
            $slipdataup = SlipTable::where('number', $request->slipnumber)->where('insured_id', $request->code_ms)->orderby('created_at', 'desc')->first();
            ...
            $notification = array(
                'message' => 'HE & Motor Slip Update successfully!',
                'alert-type' => 'success'
            );
            ...
            $deductibleup = DeductibleTemp::where('slip_id', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', 'hem')->where('status', 'passive')->orderby('id', 'desc')->get();
            ...
            $extendcoverageup = ExtendCoverageTemp::where('slip_id', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', 'hem')->where('status', 'passive')->orderby('id', 'desc')->get();
            ...
            $installmentpansup = InstallmentTemp::where('slip_id', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', 'hem')->where('status', 'passive')->orderby('id', 'desc')->get();
            ...
            $retrocessionpanup = RetrocessionTemp::where('slip_id', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', 'hem')->where('status', 'passive')->orderby('id', 'desc')->get();
            ...
            $notification = array(
                'message' => 'HE & Motor Slip added Failed!, missing data',
                'alert-type' => 'Failed'
            );
    ...
    public function endorsementhemslip($ms, $sl)
    {
        ...
        return view('crm.transaction.hem_slipendorsement', compact(['user', 'cnd', 'slipdata2', 'countendorsement', 'filelist', 'slipdata', 'insureddata', 'statuslist', 'retrocessionlist', 'installmentlist', 'extendcoveragelist', 'deductiblelist', 'extendedcoverage', 'extendedcoverage', 'deductibletype', 'interestinsured', 'locationlist', 'interestlist', 'felookup', 'currency', 'cob', 'koc', 'ocp', 'ceding', 'cedingbroker', 'route_active', 'currdate', 'slip', 'insured', 'fe_ids', 'code_ms', 'code_sl', 'costumer']));
    }
    ...
    public function storeheminsured(Request $request)
    {
        ...
        $costumcheck = Customer::where('company_name', '=', $request->hemsuggestinsured)->first();
        if ($costumcheck == null) {

            Customer::create([
                'owner_id' => '1',
                'industry_id' => '27',
                'company_prefix' => $request->heminsured,
                'company_name' => $request->hemsuggestinsured,
                'website' => $request->hemsuggestinsured,
                'company_suffix' => $request->hemsuffix
            ]);
        }
        ...
        if ($validator) {
            ...
            $locationlist = TransLocationTemp::where('insured_id', '=', $request->hemnumber)->where('slip_type', 'hem')->orderby('id', 'desc')->get();
            ...
            $checkinsurednumber = InsuredNumber::where('number', $request->hemnumber)->where('slip_type', 'hem')->where('status', 'active')->first();

            // $checkslipnumber= SlipNumber::where('number',$code_sl)->where('insured_number',$code_ms)->where('slip_type','hem')->where('status','passive')->first();
            if ($checkinsurednumber == null) {
                $insureddata = Insured::where('number', '=', $request->hemnumber)->where('slip_type','hem')->first();
                if ($insureddata == null) {
                    $insureddataup = Insured::create([
                        'number' => $request->hemnumber,
                        'slip_type' => 'hem',

                        'prefix_id' => $request->heminsured,
                        ...
                        'coincurance' => $request->hemcoincurance,
                    ...
                    $insurednumberdata = InsuredNumber::where('number', $request->hemnumber)->orderby('id', 'desc')->first();
                    $insurednumberdata->status = 'active';
                    $insurednumberdata->save();

                    $TransLocationup = TransLocationTemp::where('insured_id', '=', $request->hemnumber)->where('slip_type', 'hem')->where('status', 'passive')->orderby('id', 'desc')->get();
                    ...
                    $notification = array(
                        'message' => 'HE & MotorInsured added successfully!',
                        'alert-type' => 'success',
                    ...
                    if($insureddata->share_to != $request->hemshareto){
                        $insureddataid = $insureddata->id;
                        $insureddataup = Insured::findOrFail($insureddataid);

                        $insureddataup->prefix_id = $request->heminsured;
                        ...
                        $insureddataup->coincurance = $request->hemcoincurance;
                        ...
                        $SlipTableUp = SlipTable::where('insured_id', '=', $insureddataup->number)->where('slip_type', 'hem')->where('slipshow', 'yes')->orderby('id', 'desc')->get();
                        ...
                        $notification = array(
                            'message' => 'HE & MotorInsured Update successfully!, but tsi changed. Must Change!!!',
                            'alert-type' => 'success',
                            'count_endorsement' => $insureddataup->count_endorsement,
                            'ceding_share' => $sum_amount
                        );
                        ...
                        $notification = array(
                            'message' => 'HE & MotorInsured Update successfully!',
                            'alert-type' => 'success',
                            'count_endorsement' => $insureddataup->count_endorsement,
                            'ceding_share' => $sum_amount
                        );
                ...
                $newnumber2 = substr($request->hemnumber, 11, 16);
                $codenumber = substr($request->hemnumber, 0, 11);
                ...
                if ($insureddata == null) {
                    ...
                    $TransLocationup = TransLocationTemp::where('insured_id', '=', $code_ms2)->where('slip_type', 'hem')->where('status', 'passive')->orderby('id', 'desc')->get();
                    foreach ($TransLocationup as $tstup) {
                        $translocationprocessup = TransLocationTemp::findOrFail($tstup->id);
                        $translocationprocessup->status = 'active';
                        $translocationprocessup->save();
            ...
            return response($notification);
            //Session::flash('Success', 'HE & MotorInsured added successfully', 'success');
            //return redirect()->route('liniusaha.index');

        } else {

            $notification = array(
                'message' => 'HE & MotorInsured added Failed!',
                'alert-type' => 'success'
            );

            return back()->with($validator)->withInput();
            //Session::flash('Failed', 'HE & MotorInsured Failed added', 'danger');
            //return redirect()->route('liniusaha.index');
        }
    }
    ...
    public function storehemslip(Request $request)
    {
        ...
        if ($validator) {
            ...
            $checkslipnumber = SlipNumber::where('number', $request->slipnumber)->where('insured_number', $request->code_ms)->where('slip_type', 'hem')->where('status', 'active')->first();


            if ($checkslipnumber == null) {
                $slipdata = SlipTable::where('number', '=', $request->slipnumber)->where('insured_id','=',$request->code_ms)->where('slip_type','=','hem')->where('slipshow','=','yes')->where('selisih','=','false')->first();

                // $interestlist = InterestInsuredTemp::where('insured_id', '=', $request->code_ms)->orderby('id', 'desc')->get();
                // $installmentlist = InstallmentTemp::where('slip_id', '=', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'hem')->where('deleted_at', null)->orderby('id', 'desc')->get();
                // $extendcoveragelist = ExtendCoverageTemp::where('slip_id', '=', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'hem')->where('deleted_at', null)->orderby('id', 'desc')->get();
                // $deductiblelist = DeductibleTemp::where('slip_id', '=', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'hem')->where('deleted_at', null)->orderby('id', 'desc')->get();
                // $retrocessionlist = RetrocessionTemp::where('slip_id', '=', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'hem')->where('deleted_at', null)->orderby('id', 'desc')->get();

                $interestlist = InterestInsuredTemp::where('insured_id', '=', $request->code_ms)->orderby('id', 'desc')->get();
                $installmentlist = InstallmentTemp::where('slip_id', '=', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'hem')->where('minus','false')->where('count_endorsement',0)->where('deleted_at', null)->orderby('id', 'desc')->get();
                $extendcoveragelist = ExtendCoverageTemp::where('slip_id', '=', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'hem')->where('minus','false')->where('count_endorsement',0)->where('deleted_at', null)->orderby('id', 'desc')->get();
                $deductiblelist = DeductibleTemp::where('slip_id', '=', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'hem')->where('minus','false')->where('count_endorsement',0)->where('deleted_at', null)->orderby('id', 'desc')->get();
                $retrocessionlist = RetrocessionTemp::where('slip_id', '=', $request->slipnumber)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'hem')->where('minus','false')->where('count_endorsement',0)->where('deleted_at', null)->orderby('id', 'desc')->get();
                ...
                if ($slipdata == null) {
                    ...
                    //$insdata = Insured::where('number',$request->code_ms)->where('slip_type','hem')->first();
                    $insdata = Insured::where('number', $request->code_ms)->first();
                    ...
                    $slipnumberdata = SlipNumber::where('number', $request->slipnumber)->where('slip_type', 'hem')->orderby('id', 'desc')->first();
                    ...
                    $currdate2 = date("Y-m-d");
                    $mydate = date("Y") . date("m") . date("d");
                    $slip_now = SlipTable::whereDate('created_at', $currdate2)->where('slip_type', 'hem')->where('insured_id', $request->code_ms)->orderby('id', 'asc')->get();
                    $sliplastid = count($slip_now);
                    // dd($sliplastid);
                ...
                $interestlist = InterestInsuredTemp::where('insured_id', '=', $request->code_ms)->orderby('id', 'desc')->get();
                $installmentlist = InstallmentTemp::where('slip_id', '=', $code_sl2)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'hem')->orderby('id', 'desc')->get();
                $extendcoveragelist = ExtendCoverageTemp::where('slip_id', '=', $code_sl2)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'hem')->orderby('id', 'desc')->get();
                $deductiblelist = DeductibleTemp::where('slip_id', '=', $code_sl2)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'hem')->orderby('id', 'desc')->get();
                $retrocessionlist = RetrocessionTemp::where('slip_id', '=', $code_sl2)->where('insured_id', '=', $request->code_ms)->where('slip_type', '=', 'hem')->orderby('id', 'desc')->get();
                ...
                if ($slipdata == null) {
                    ...
                    $slipnumberdata = SlipNumber::where('number', $code_sl2)->where('slip_type', 'hem')->orderby('id', 'desc')->first();
                    $slipnumberdata->status = 'active';
                    $slipnumberdata->save();
                    ...
                    $deductibleup = DeductibleTemp::where('slip_id', $code_sl2)->where('insured_id', '=', $request->code_ms)->where('slip_type', 'hem')->where('status', 'passive')->orderby('id', 'desc')->get();
                    foreach ($deductibleup as $ddup) {
                        $deductibleprocessup = DeductibleTemp::findOrFail($ddup->id);
                        $deductibleprocessup->status = 'active';
                        $deductibleprocessup->save();
                    ...
                    $extendcoverageup = ExtendCoverageTemp::where('slip_id', $code_sl2)->where('insured_id', '=', $request->code_ms)->where('slip_type', 'hem')->where('status', 'passive')->orderby('id', 'desc')->get();
                    foreach ($extendcoverageup as $ecup) {
                        $extendcoverageprocessup = ExtendCoverageTemp::findOrFail($ecup->id);
                        $extendcoverageprocessup->status = 'active';
                        $extendcoverageprocessup->save();
                    ...
                    $installmentpansup = InstallmentTemp::where('slip_id', $code_sl2)->where('insured_id', '=', $request->code_ms)->where('slip_type', 'hem')->where('status', 'passive')->orderby('id', 'desc')->get();
                    foreach ($installmentpansup as $ipup) {
                        $inspanprocessup = InstallmentTemp::findOrFail($ipup->id);
                        $inspanprocessup->status = 'active';
                        $inspanprocessup->save();
                    ...
                    $retrocessionpanup = RetrocessionTemp::where('slip_id', $code_sl2)->where('insured_id', '=', $request->code_ms)->where('slip_type', 'hem')->where('status', 'passive')->orderby('id', 'desc')->get();
                    foreach ($retrocessionpanup as $rpup) {
                        $retropanprocessup = RetrocessionTemp::findOrFail($rpup->id);
                        $retropanprocessup->status = 'active';
                        $retropanprocessup->save();
    ...
    //                 $notification = array(
    //                     'message' => 'HE & Motor Slip added successfully!',
    //                     'alert-type' => 'success'
    //                 );
    ...
    //             }
    //         } else {
    //             $newnumber2 = substr($request->slipnumber, 11, 16);
    //             $codenumber = substr($request->slipnumber, 0, 11);
    ...
    public function storeendorsementhemslip(Request $request)
    {
        $validator = $request->validate([
            'slipid' => 'required'
        ]);
        ...
        if ($validator) {
            ...
            $slipdatalist = SlipTable::where('id', '=', $request->slipid)->where('insured_id', '=', $slipdata->insured_id)->where('endorsment',$slipdata->endorsment)->where('slip_type', 'hem')->orderby('id', 'desc')->first();
            $insureddata = Insured::where('number', '=', $slipdata->insured_id)->where('slip_type', '=', 'hem')->where('count_endorsement', $slipdata->endorsment)->first();
            ...
            $installmentlist = InstallmentTemp::where('slip_id', '=', $slipdata->number)->where('insured_id', '=', $slipdata->insured_id)->where('slip_type', '=', 'hem')->where('minus','false')->where('count_endorsement',$request->countendorsement)->where('deleted_at', null)->orderby('id', 'desc')->get();
            $extendcoveragelist = ExtendCoverageTemp::where('slip_id', '=', $slipdata->number)->where('insured_id', '=', $slipdata->insured_id)->where('slip_type', '=', 'hem')->where('minus','false')->where('count_endorsement',$request->countendorsement)->where('deleted_at', null)->orderby('id', 'desc')->get();
            $deductiblelist = DeductibleTemp::where('slip_id', '=', $slipdata->number)->where('insured_id', '=', $slipdata->insured_id)->where('slip_type', '=', 'hem')->where('minus','false')->where('count_endorsement',$request->countendorsement)->where('deleted_at', null)->orderby('id', 'desc')->get();
            $retrocessionlist = RetrocessionTemp::where('slip_id', '=', $slipdata->number)->where('insured_id', '=', $slipdata->insured_id)->where('slip_type', '=', 'hem')->where('minus','false')->where('count_endorsement',$request->countendorsement)->where('deleted_at', null)->orderby('id', 'desc')->get();
            $locationlist = TransLocationTemp::where('insured_id', '=', $slipdata->insured_id)->where('slip_type', '=', 'hem')->orderby('id', 'desc')->get();
            $attachmentlist = SlipTableFile::where('slip_id', '=', $slipdata->number)->where('insured_id', '=', $slipdata->insured_id)->where('slip_type', '=', 'hem')->orderby('id', 'desc')->get();
                ...
                if ($slipdatalast == null) {
                    ...
                    if ($deductiblelist != null) {
                        foreach ($deductiblelist as $dt) {
                            ...
                            $jsondtlistupminus = DeductibleTemp::where('slip_id', '=', $dtdata->slip_id)->where('insured_id', '=', $dtdata->insured_id)->where('slip_type','hem')->where('minus','true')->where('count_endorsement', $dtlistupminus->count_endorsement)->where('deleted_at', null)->orderby('id', 'desc')->get();
                    ...
                    if ($extendcoveragelist != null) {
                        foreach ($extendcoveragelist as $ect) {
                            ...
                            $datajsonectlistup = collect(ExtendCoverageTemp::where('slip_id', '=', $ectlistup->slip_id)
                                                ...
                                                ->where('slip_type','hem')->where('minus','false')
                            ...
                            $jsonectlistupminus = ExtendCoverageTemp::where('slip_id', '=', $ectdata->slip_id)->where('insured_id', '=', $ectdata->insured_id)->where('slip_type','hem')->where('minus','true')->where('count_endorsement', $ectdata->count_endorsement)->where('deleted_at', null)->orderby('id', 'desc')->get();
                    ...
                    if ($installmentlist != null) {
                        foreach ($installmentlist as $ipt) {
                            ...
                            $jsoniptlistupminus = InstallmentTemp::where('slip_id', '=', $iptdata->slip_id)->where('insured_id', '=', $iptdata->insured_id)->where('slip_type','hem')->where('minus','true')->where('count_endorsement', $iptdata->count_endorsement)->where('deleted_at', null)->orderby('id', 'desc')->get();
                    ...
                    if (!$retrocessionlist) {
                        ...
                        foreach ($retrocessionlist as $rct) {
                            ...
                            $jsonrctlistup = RetrocessionTemp::where('slip_id', '=', $rctlistup->slip_id)->where('insured_id', '=', $rctlistup->insured_id)->where('slip_type','hem')->where('minus','false')->where('count_endorsement', $rctlistup->count_endorsement)->where('deleted_at', null)->orderby('id', 'desc')->get();
                            ...
                            $jsonrctlistupminus = RetrocessionTemp::where('slip_id', '=', $rctdata->slip_id)->where('insured_id', '=', $rctdata->insured_id)->where('slip_type','hem')->where('minus','true')->where('count_endorsement', $rctdata->count_endorsement)->where('deleted_at', null)->orderby('id', 'desc')->get();
                    ...
                    $attachmentcheck = SlipTableFile::where('slip_id', $slipdata->number)->where('insured_id', $slipdata->insured_id)->where('count_endorsement', $slipdata->endorsment)->where('slip_type', 'hem')->get();
                    ...
                    $statuslogcheck = StatusLog::where('slip_id', $slipdata->number)->where('insured_id', $slipdata->insured_id)->where('count_endorsement', $slipdata->endorsment)->where('slip_type', 'hem')->get();
                    ...
                    $slipdatalist2 = SlipTable::where('insured_id', '=', $slipdata->insured_id)->where('slip_type', '=', 'hem')->get();
                    ...
                    $maxdata = SlipTable::where('insured_id', $slipdataup->insured_id)->where('slip_type', 'hem')->orderby('endorsment', 'desc')->first();
    ...
    public function updateendorsement(Request $request)
    {
        ...
        $notification = array(
            'message' => 'He & Motor Slip Update Endorsement successfully!',
            'alert-type' => 'success'
        );
    ...
    public function changeDecline($id)
    {
        ...
        $notification = array(
            'message' => 'He & Motor Insured & Slip Status Decline successfully!',
            'alert-type' => 'success'
        );
        return back()->with($notification);
    }
    ...
    public function changeCancel($id)
    {
        ...
        $notification = array(
            'message' => 'He & Motor Insured & Slip Status Cancel successfully!',
            'alert-type' => 'success'
        );
        return back()->with($notification);
    }

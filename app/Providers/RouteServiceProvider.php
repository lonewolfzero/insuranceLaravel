...
class RouteServiceProvider extends ServiceProvider
{
    ...
    public function map()
    {
        ...
        $this->mapFacultativeSyariahRoutes();
        $this->mapClaimTransactionRoutes();
        $this->mapTreatyRoutes();
        $this->mapRetroRoutes();
    ...
    protected function mapFacultativeSyariahRoutes()
    {
        Route::middleware('web')
            ->namespace($this->namespace)
            ->group(base_path('routes/crm/facultativeSyariahRoutes.php'));
    }
    ...
    protected function mapTreatyRoutes()
    {
        Route::middleware('web')
            ->namespace($this->namespace)
            ->group(base_path('routes/crm/treatyRoutes.php'));
    }

    protected function mapRetroRoutes()
    {
        Route::middleware('web')
            ->namespace($this->namespace)
            ->group(base_path('routes/crm/retroRoutes.php'));
    }
}
